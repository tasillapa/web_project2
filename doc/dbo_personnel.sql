...
CREATE TABLE `ps_address` (
  ...
  `address_number` varchar(10) NOT NULL COMMENT 'เลขที่',
  `address_swine` varchar(10) NOT NULL COMMENT 'หมู่',
  `address_soi` varchar(30) NOT NULL COMMENT 'ซอย',
  `address_road` varchar(30) NOT NULL COMMENT 'ถนน',
  `address_village` varchar(30) NOT NULL COMMENT 'หมู่บ้าน',
  `address_province` int(5) NOT NULL COMMENT 'จังหวัด',
  ...
  `address_call` varchar(10) NOT NULL COMMENT 'โทร.',
  `address_fhone` varchar(9) NOT NULL COMMENT 'มือถือ',
...
--
-- Table structure for table `ps_amphur`
--

CREATE TABLE `ps_amphur` (
  `AMPHUR_ID` int(5) NOT NULL,
  `AMPHUR_CODE` varchar(4) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รหัสอำเภอ',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='อำเภอ';

--
-- Dumping data for table `ps_amphur`
--

INSERT INTO `ps_amphur` (`AMPHUR_ID`, `AMPHUR_CODE`, `AMPHUR_NAME`, `POSTCODE`, `GEO_ID`, `PROVINCE_ID`) VALUES
...
CREATE TABLE `ps_bank` (
  ...
  `bank_code` int(3) UNSIGNED ZEROFILL NOT NULL COMMENT 'รหัสธนาคาร',
  `bank_name` varchar(50) NOT NULL COMMENT 'ธนาคาร'
...
INSERT INTO `ps_bank` (`bank_id`, `bank_code`, `bank_name`) VALUES
...
(12, 024, 'ธนาคารยูโอบี'),
(13, 030, 'ธนาคารออมสิน'),
(14, 066, 'ธนาคารอิสลามแห่งประเทศไทย'),
(15, 033, 'ธนาคารอาคารสงเคราะห์');

-- --------------------------------------------------------

--
-- Table structure for table `ps_blame`
--

CREATE TABLE `ps_blame` (
  `blame_id` int(4) UNSIGNED ZEROFILL NOT NULL,
  `blame_name` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'ความผิด',
  `blame_somename` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'กรณีความผิด',
  `blame_date` date NOT NULL COMMENT 'วันที่รับโทษ',
...
--
-- Table structure for table `ps_changname`
--

CREATE TABLE `ps_changname` (
  `chang_id` int(4) UNSIGNED ZEROFILL NOT NULL,
  `chang_nameold` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'ชื่อ-สกุลเดิม',
  `chang_namenew` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'ชื่อ-สกุลใหม่',
  `chang_date` date NOT NULL COMMENT 'วันที่เปลี่ยน',
  `pro_id` varchar(5) COLLATE utf8_unicode_ci NOT NULL COMMENT 'id ps_profile'
...
--
-- Table structure for table `ps_class`
--
...
CREATE TABLE `ps_department` (
  ...
  `dep_code` int(4) UNSIGNED ZEROFILL NOT NULL COMMENT 'รหัสสังกัด',
  `dep_name` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'สังกัด'
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `ps_district`
--

CREATE TABLE `ps_district` (
  ...
  `PROVINCE_ID` int(5) NOT NULL DEFAULT '0',
  `GEO_ID` int(5) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ตำบล';

--
-- Dumping data for table `ps_district`
--

INSERT INTO `ps_district` (`DISTRICT_ID`, `DISTRICT_CODE`, `DISTRICT_NAME`, `AMPHUR_ID`, `PROVINCE_ID`, `GEO_ID`) VALUES
...
CREATE TABLE `ps_geninformation` (
  `gen_id` int(4) NOT NULL,
  `gen_card_id` varchar(13) NOT NULL COMMENT 'เลขบัตรประชาชน',
  `gen_prefix` varchar(10) NOT NULL COMMENT 'คำนำหน้าเพศ',
  `gen_old` varchar(3) NOT NULL COMMENT 'อายุ',
  `PROVINCE_ID` int(5) NOT NULL COMMENT 'จังหวัดที่เกิด',
  `nationality_id` int(4) NOT NULL COMMENT 'สัญชาติ',
  `nationality_id_race` int(4) NOT NULL COMMENT 'เชื้อชาติ',
  `religion_id` int(2) NOT NULL COMMENT 'ศาสนา',
  `gen_blood` varchar(5) NOT NULL COMMENT 'กรุ๊ปเลือด',
  `gen_soldier` varchar(20) NOT NULL COMMENT 'สถานะทางทหาร',
  `gen_tax` varchar(13) NOT NULL COMMENT 'เลขผู้เสียภาษี',
  `gen_passport` text NOT NULL COMMENT 'เลขพาสปอต',
  `bank_id` int(4) NOT NULL COMMENT 'ธนาคาร',
  `gen_account_number` varchar(10) NOT NULL COMMENT 'เลขบัญชีธนาคาร',
  `gen_email` varchar(50) NOT NULL COMMENT 'อีเมล',
  `gen_facebook` varchar(50) NOT NULL COMMENT 'เฟสบุ๊ค',
  `gen_twitter` varchar(50) NOT NULL COMMENT 'ทวิตเตอร์',
  `gen_line` varchar(20) NOT NULL COMMENT 'ไลท์',
  `gen_talent` text NOT NULL COMMENT 'ความสามารถพิเศษ',
  `gen_interest` text NOT NULL COMMENT 'ความสนใจ',
  `expert_name` text NOT NULL COMMENT 'ความชำนาญ',
  `expert_ex` text NOT NULL COMMENT 'ตัวอย่างความชำนาญ',
  `pro_id` int(4) NOT NULL COMMENT 'รหัสโปรไฟล์'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ข้อมูลทั่วไป';

--
-- Dumping data for table `ps_geninformation`
--
...
--
-- Table structure for table `ps_geography`
--

CREATE TABLE `ps_geography` (
  `GEO_ID` int(5) NOT NULL,
  `GEO_NAME` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='ภาค';

--
-- Dumping data for table `ps_geography`
--

INSERT INTO `ps_geography` (`GEO_ID`, `GEO_NAME`) VALUES
(1, 'ภาคเหนือ'),
(2, 'ภาคกลาง'),
...
--
-- Table structure for table `ps_heir`
--

CREATE TABLE `ps_heir` (
  `id_heir` int(4) UNSIGNED ZEROFILL NOT NULL,
  `heir_name` text COLLATE utf8_unicode_ci NOT NULL,
  `heir_relationship` text COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `ps_hismarry`
--

CREATE TABLE `ps_hismarry` (
  `marry_id` int(4) UNSIGNED ZEROFILL NOT NULL,
  `marry_name` text COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Table structure for table `ps_hismeetting`
--
...
--
-- Table structure for table `ps_hisroyal`
--
...
--
-- Table structure for table `ps_hissalaryup`
--
...
--
-- Table structure for table `ps_hisservice`
--
...
--
-- Table structure for table `ps_level`
--
...
--
-- Table structure for table `ps_leveleducation`
--

CREATE TABLE `ps_leveleducation` (
  `edu_id` int(4) UNSIGNED ZEROFILL NOT NULL,
  `edu_code` int(4) UNSIGNED ZEROFILL NOT NULL,
  `edu_name` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `ps_leveleducation`
--

INSERT INTO `ps_leveleducation` (`edu_id`, `edu_code`, `edu_name`) VALUES
(0001, 0001, 'ประกาศนียบัตรวิชาชีพ (ป.ว.ช)'),
(0002, 0002, 'ประกาศนียบัตรวิชาชีพชั้นสูง (ป.ว.ส)'),
(0003, 0003, 'มัธยมศึกษาตอนต้น'),
(0004, 0004, 'มัธยมศึกษาตอนปลาย'),
(0005, 0005, 'ปริญญาตรี'),
(0006, 0006, 'ปริญญาโท'),
(0007, 0007, 'ปริญญาเอก');
...
--
-- Table structure for table `ps_nationality`
--

CREATE TABLE `ps_nationality` (
  `nationality_id` int(4) NOT NULL,
  `nationality_code` int(4) UNSIGNED ZEROFILL NOT NULL,
  `nationality_name` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ps_nationality`
--

INSERT INTO `ps_nationality` (`nationality_id`, `nationality_code`, `nationality_name`) VALUES
(0, 0002, 'โปรตุเกส'),
(2, 0003, 'ดัตช์'),
(3, 0004, 'เยอรมัน'),
(4, 0005, 'ฝรั่งเศส'),
...
(56, 0057, 'กัมพูชา'),
(57, 0058, 'ศรีลังกา'),
(58, 0059, 'ซาอุดีอาระเบีย'),
(59, 0060, 'อิสราเอล'),
(60, 0061, 'เลบานอน'),
(61, 0062, 'อิหร่าน'),
(62, 0063, 'ตุรกี'),
(63, 0064, 'บังกลาเทศ'),
(64, 0065, 'ถูกถอนสัญชาติ'),
(65, 0066, 'ซีเรีย'),
(66, 0067, 'อิรัก'),
(67, 0068, 'คูเวต'),
(68, 0069, 'บรูไน'),
...
(74, 0075, 'เอธิโอเปีย'),
(75, 0076, 'ไนจีเรีย'),
(76, 0077, 'สหรัฐอาหรับเอมิเรตส์'),
(77, 0078, 'กินี'),
(78, 0079, 'ออสเตรเลีย'),
(79, 0080, 'นิวซีแลนด์'),
(80, 0081, 'ปาปัวนิวกินี'),
(81, 0082, 'ม้ง'),
(82, 0083, 'เมี่ยน'),
(83, 0086, 'จีนฮ่อ'),
(84, 0087, 'จีน (อดีตทหารจีนคณะชาติ ,อดีตทหารจีนชาติ)'),
(85, 0088, 'ผู้พลัดถิ่นสัญชาติพม่า'),
(86, 0089, 'ผู้อพยพเชื้อสายจากกัมพูชา'),
(87, 0090, 'ลาว (ลาวอพยพ)'),
(88, 0091, 'เขมรอพยพ'),
(89, 0096, 'ไร้สัญชาติ'),
(90, 0097, 'อื่นๆ'),
(91, 0098, 'ไม่ได้สัญชาติไทย'),
(92, 0099, 'ไทย'),
(93, 0100, 'อัฟกัน'),
(94, 0101, 'บาห์เรน'),
(95, 0102, 'ภูฏาน'),
...
(101, 0108, 'กาตาร์'),
(102, 0109, 'เยเมน'),
(103, 0111, 'หมู่เกาะฟิจิ'),
(104, 0112, 'คิริบาส'),
(105, 0113, 'นาอูรู'),
(106, 0114, 'หมู่เกาะโซโลมอน'),
(107, 0115, 'ตองก้า'),
(108, 0116, 'ตูวาลู'),
(109, 0117, 'วานูอาตู'),
(110, 0118, 'ซามัว'),
...
(112, 0120, 'อันดอร์รา'),
(113, 0122, 'ไอซ์แลนด์'),
(114, 0123, 'ลิกเตนสไตน์'),
(115, 0124, 'โมนาโก'),
(116, 0125, 'ซานมารีโน'),
(117, 0126, 'บริติช  (อังกฤษ, สก็อตแลนด์)'),
(118, 0127, 'แอลจีเรีย'),
(119, 0128, 'แองโกลา'),
(120, 0129, 'เบนิน'),
(121, 0130, 'บอตสวานา'),
(122, 0131, 'บูร์กินาฟาโซ'),
(123, 0132, 'บุรุนดี'),
(124, 0133, 'แคเมอรูน'),
(125, 0134, 'เคปเวิร์ด'),
(126, 0135, 'แอฟริกากลาง'),
(127, 0136, 'ชาด'),
(128, 0137, 'คอสตาริกา'),
(129, 0138, 'คองโก'),
(130, 0139, 'ไอโวเรี่ยน'),
(131, 0140, 'จิบูตี'),
(132, 0141, 'อิเควทอเรียลกินี'),
(133, 0142, 'กาบอง'),
(134, 0143, 'แกมเบีย'),
(135, 0144, 'กานา'),
(136, 0145, 'กินีบีสเซา'),
...
(147, 0156, 'ไนเจอร์'),
(148, 0157, 'รวันดา'),
(149, 0158, 'เซาโตเมและปรินซิเป'),
(150, 0159, 'เซเนกัล'),
(151, 0160, 'เซเชลส์'),
(152, 0161, 'เซียร์ราลีโอน'),
(153, 0162, 'โซมาลี'),
(154, 0163, 'ซูดาน'),
(155, 0164, 'สวาซี'),
(156, 0165, 'แทนซาเนีย'),
...
(175, 0184, 'จาเมกา'),
(176, 0185, 'นิการากัว'),
(177, 0186, 'เซนต์คิตส์และเนวิส'),
(178, 0187, 'เซนต์ลูเซีย'),
(179, 0188, 'เซนต์วินเซนต์และเกรนาดีนส์'),
(180, 0189, 'ตรินิแดดและโตเบโก'),
(181, 0190, 'โบลีเวีย'),
(182, 0191, 'เอกวาดอร์'),
(183, 0192, 'กายอานา'),
(184, 0193, 'ปารากวัย'),
...
(197, 0208, 'มอญ'),
(198, 0209, 'มลาบรี'),
(199, 0212, 'จีน (จีนฮ่ออิสระ)'),
(200, 0214, 'จีน (จีนฮ่ออพยพ)'),
(201, 0216, 'ยูเครน'),
(202, 0219, 'จีน(ฮ่องกง)'),
(203, 0220, 'จีน(ไต้หวัน)'),
(204, 0221, 'โครเอเชีย'),
(205, 0223, 'คาซัค'),
(206, 0224, 'อาร์เมเนีย'),
(207, 0225, 'อาเซอร์ไบจาน'),
(208, 0226, 'จอร์เจีย'),
(209, 0227, 'คีร์กีซ'),
(210, 0228, 'ทาจิก'),
(211, 0229, 'อุซเบก'),
(212, 0230, 'หมู่เกาะมาร์แชลล์'),
(213, 0231, 'ไมโครนีเซีย'),
(214, 0232, 'ปาเลา'),
(215, 0233, 'เบลารุส'),
(216, 0234, 'บอสเนียและเฮอร์เซโกวีนา'),
(217, 0235, 'เติร์กเมน'),
(218, 0236, 'เอสโตเนีย'),
(219, 0237, 'ลัตเวีย'),
(220, 0238, 'ลิทัวเนีย'),
...
(226, 0244, 'นามิเบีย'),
(227, 0245, 'โบลิเวีย'),
(228, 0246, 'หมู่เกาะคุก'),
(229, 0247, 'เนปาล (เนปาลอพยพ)'),
(230, 0248, 'มอญ  (ผู้พลัดถิ่นสัญชาติพม่า)'),
(231, 0249, 'ไทยใหญ่  (ผู้พลัดถิ่นสัญชาติพม่า)'),
(232, 0250, 'เวียดนาม  (ญวนอพยพ)'),
(233, 0251, 'มาเลเชีย  (อดีต จีนคอมมิวนิสต์)'),
(234, 0252, 'จีน  (อดีต จีนคอมมิวนิสต์)'),
(235, 0253, 'สิงคโปร์  (อดีต จีนคอมมิวนิสต์)'),
(236, 0254, 'กะเหรี่ยง  (ผู้หลบหนีเข้าเมือง)'),
(237, 0255, 'มอญ  (ผู้หลบหนีเข้าเมือง)'),
(238, 0256, 'ไทยใหญ่  (ผู้หลบหนีเข้าเมือง)'),
(239, 0257, 'กัมพูชา  (ผู้หลบหนีเข้าเมือง)'),
(240, 0258, 'มอญ  (ชุมชนบนพื้นที่สูง)'),
(241, 0259, 'กะเหรี่ยง  (ชุมชนบนพื้นที่สูง)'),
(242, 0260, 'ปาเลสไตน์'),
(243, 0261, 'ติมอร์ตะวันออก'),
(244, 0262, 'สละสัญชาติไทย'),
(245, 0263, 'เซอร์เบีย แอนด์ มอนเตเนโกร'),
(246, 0264, 'กัมพูชา(แรงงาน)'),
(247, 0265, 'พม่า(แรงงาน)'),
(248, 0266, 'ลาว(แรงงาน)'),
(249, 0267, 'เซอร์เบียน'),
(250, 0268, 'มอนเตเนกริน'),
(251, 0989, 'บุคคลที่ไม่มีสถานะทางทะเบียน'),
(252, 0999, 'ไม่ระบุ');

-- --------------------------------------------------------

--
-- Table structure for table `ps_officeout`
--

CREATE TABLE `ps_officeout` (
  `id_off` int(4) UNSIGNED ZEROFILL NOT NULL,
  `off_number` int(4) UNSIGNED ZEROFILL NOT NULL,
  `off_name` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `ps_officeout`
--

INSERT INTO `ps_officeout` (`id_off`, `off_number`, `off_name`) VALUES
(0004, 0111, 'สำนักงานเอดส์'),
(0005, 0112, 'สำนักงานสาธารณสุข'),
(0006, 0113, 'สำนักระบาดวิทยา');

-- --------------------------------------------------------

--
-- Table structure for table `ps_personnal`
--

CREATE TABLE `ps_personnal` (
  `member_id` int(11) NOT NULL,
  `card_id` varchar(13) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `nameuser` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `person_create` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT 'คนสร้าง',
  `date_create` datetime NOT NULL COMMENT 'วันที่สร้าง',
  `person_update` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT 'คนแก้ไขล่าสุด',
  `date_update` datetime NOT NULL COMMENT 'วันที่แก้ไขล่าสุด'
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `ps_position`
--
...
--
-- Dumping data for table `ps_position`
--
...
(0004, 0104, 'เภสัชกร'),
(0005, 0105, 'นักสังคมสงเคราะห์'),
(0006, 0106, 'นักวิเคราะห์นโยบายและแผน'),
(0007, 0107, 'นักเทคนิคการแพทย์'),
(0008, 0108, 'เจ้าพนักงานวิทย์ฯการแพทย์'),
(0009, 0109, 'เจ้าพนักงานเภสัชกรรม'),
(0010, 0110, 'นักวิชาการการเงินและบัญชี'),
(0011, 0111, 'นักจัดการงานทั่วไป'),
(0012, 0112, 'เจ้าพนักงานการเงินและบัญชี'),
(0013, 0113, 'นักวิชาการพัสดุ'),
(0014, 0114, 'เจ้าพนักงานพัสดุ'),
(0015, 0115, 'เจ้าพนักงานธุรการ'),
(0016, 0116, 'เจ้าพนักงานสาธารณสุข'),
(0017, 0117, 'นักรังสีการแพทย์'),
(0018, 0118, 'นักทรัพยากรบุคคล'),
(0019, 0119, 'นักวิชาการเผยแพร่'),
(0020, 0120, 'นักประชาสัมพันธ์'),
(0021, 0121, 'นิติกร'),
(0122, 0123, 'เจ้าพนักงานคอมพิวเตอร์'),
(0121, 0122, 'นักวิชาการคอมพิวเตอร์'),
(0123, 0124, 'พนักงานปฏิบัติการพาหะส2'),
(0124, 0125, 'พนักงานปฏิบัติการชันสูตรส2'),
(0125, 0126, 'พนักงานพิมพ์ระดับส3'),
(0126, 0127, 'พนักงานขับรถยนต์ส2'),
(0127, 0128, 'พนักงานทั่วไประดับส2'),
(0130, 0129, 'พนักงานทั่วไป1'),
(0129, 0130, 'ผู้ข่วยเหลือคนไข้'),
(0131, 0131, 'แม่บ้านระดับ บ2'),
(0132, 0132, 'พนักงานทั่วไประดับ บ2'),
(0133, 0133, 'พนักงานธุรการระดับ ส2'),
(0135, 0134, 'พนักงานธุรการระดับ ส3'),
(0136, 0135, 'พนักงานสถานที่ระดับ บ2'),
(0138, 0136, 'พนักงานเยี่ยมบ้านระดับ ส2'),
(0139, 0137, 'ช่างเครื่องยนต์ระดับ ช2'),
...
--
-- Table structure for table `ps_preaddress`
--
...
CREATE TABLE `ps_preaddress` (
  ...
  `pread_road` varchar(30) NOT NULL COMMENT 'ถนน',
  `pread_village` varchar(30) NOT NULL COMMENT 'หมู่ย้าน',
  `pread_province` int(5) NOT NULL COMMENT 'จังหวัด',
...
--
-- Dumping data for table `ps_preaddress`
--
...
--
-- Table structure for table `ps_prefix`
--

CREATE TABLE `ps_prefix` (
  `pf_id` int(2) UNSIGNED NOT NULL COMMENT 'รหัส',
  `pf_name` varchar(50) NOT NULL COMMENT 'คำนำหน้า'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ps_prefix`
--

INSERT INTO `ps_prefix` (`pf_id`, `pf_name`) VALUES
(1, 'นาย'),
(2, 'นาง'),
(3, 'นางสาว'),
(4, 'หม่อมหลวง\r\n'),
(5, 'หม่อมราชวงศ์\r\n'),
(6, 'หม่อมเจ้า\r\n'),
(7, 'ศาสตราจารย์เกียรติคุณ (กิตติคุณ)\r\n'),
(8, 'ศาสตราจารย์\r\n'),
...
CREATE TABLE `ps_profile` (
  ...
  `card_id` varchar(13) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'เลขบัตรประชาชน',
  `pro_idpos` int(4) UNSIGNED ZEROFILL NOT NULL COMMENT 'เลขที่ตำแหน่ง',
  `pro_sex` int(1) NOT NULL COMMENT 'เพศ',
  `pro_prefix` varchar(50) NOT NULL COMMENT 'คำนำหน้า',
  `pro_fname` varchar(50) NOT NULL COMMENT 'ชื่อ',
  `pro_lname` varchar(50) NOT NULL COMMENT 'นามสกุล',
  `pro_nickname` varchar(50) NOT NULL COMMENT 'ชื่อเล่น',
  `pro_birthday` date NOT NULL COMMENT 'วันเกิด',
  `pro_status` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT 'สถานะ',
  `pos_id` int(4) UNSIGNED ZEROFILL NOT NULL COMMENT 'ตำแหน่ง',
  `type_id` int(4) NOT NULL COMMENT 'ประเภท',
  `lvb_id` int(4) NOT NULL COMMENT 'ตำแหน่งบริหาร',
  `lv_id` int(4) NOT NULL COMMENT 'ระดับ',
  `class_id` int(4) UNSIGNED ZEROFILL NOT NULL COMMENT 'กลุ่มงาน',
  `dep_id` int(4) UNSIGNED ZEROFILL NOT NULL COMMENT 'สังกัด',
...
--
-- Table structure for table `ps_province`
--

CREATE TABLE `ps_province` (
...
--
-- Dumping data for table `ps_province`
--

INSERT INTO `ps_province` (`PROVINCE_ID`, `PROVINCE_CODE`, `PROVINCE_NAME`, `GEO_ID`) VALUES
...
--
-- Table structure for table `ps_receiveservice`
--

CREATE TABLE `ps_receiveservice` (
  `service_id` int(4) UNSIGNED ZEROFILL NOT NULL,
  `service_date` date NOT NULL,
  `service_special` text COLLATE utf8_unicode_ci NOT NULL,
  `service_header` text COLLATE utf8_unicode_ci NOT NULL,
  `service_location` text COLLATE utf8_unicode_ci NOT NULL,
  `service_number` int(4) UNSIGNED ZEROFILL NOT NULL,
  `service_note` text COLLATE utf8_unicode_ci NOT NULL,
  `card_id` varchar(13) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Table structure for table `ps_religion`
--

CREATE TABLE `ps_religion` (
  `religion_id` int(2) NOT NULL COMMENT 'ไอดัี',
  `religion_code` int(4) UNSIGNED ZEROFILL NOT NULL COMMENT 'รหัสศาสนา',
  `religio_name` varchar(20) NOT NULL COMMENT 'ชื่อศาสนา'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ps_religion`
--

INSERT INTO `ps_religion` (`religion_id`, `religion_code`, `religio_name`) VALUES
(1, 0001, 'ยูดาห์'),
(2, 0002, 'คริสต์'),
(3, 0003, 'อิสลาม'),
(4, 0004, 'บาไฮ'),
...
--
-- Table structure for table `ps_skillful`
--

CREATE TABLE `ps_skillful` (
  `skill_id` int(4) UNSIGNED ZEROFILL NOT NULL,
  `skill_name` text COLLATE utf8_unicode_ci NOT NULL,
  `skill_somename` text COLLATE utf8_unicode_ci NOT NULL,
  `card_id` varchar(13) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `tb_profile` (
  `card_id` varchar(13) COLLATE utf8_unicode_ci NOT NULL COMMENT 'บัตรประชาชน',
  `pro_idpos` int(4) UNSIGNED ZEROFILL NOT NULL,
  `pro_sex` int(1) NOT NULL,
  `pro_first` varchar(5) CHARACTER SET utf8 NOT NULL,
  `pro_name` text CHARACTER SET utf8 NOT NULL,
  `pro_birthday` date NOT NULL,
  `pro_status` text COLLATE utf8_unicode_ci NOT NULL,
  `pro_position` int(4) UNSIGNED ZEROFILL NOT NULL COMMENT 'ตำแหน่ง',
  `pro_type` int(1) NOT NULL COMMENT 'ประเภท',
  `pro_linework` int(1) NOT NULL COMMENT 'สายงาน',
  `pro_level` int(1) NOT NULL COMMENT 'ระดับ',
  `code_class` int(4) UNSIGNED ZEROFILL NOT NULL,
  `dep_code` int(4) UNSIGNED ZEROFILL NOT NULL,
  `pro_salary` text COLLATE utf8_unicode_ci NOT NULL,
  `status_boss` int(1) NOT NULL,
  `pro_datefromservice` date NOT NULL,
  `pro_datetoservice` date NOT NULL,
  `pro_filepic` text COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `tb_profile` (`card_id`, `pro_idpos`, `pro_sex`, `pro_first`, `pro_name`, `pro_birthday`, `pro_status`, `pro_position`, `pro_type`, `pro_linework`, `pro_level`, `code_class`, `dep_code`, `pro_salary`, `status_boss`, `pro_datefromservice`, `pro_datetoservice`, `pro_filepic`, `id_profile`) VALUES
('1560300086281', 1202, 2, 'น.ส', 'นางสาวทิพวรรณ ชาวเวียง', '1986-07-05', 'สมรส', 0102, 1, 2, 6, 0112, 0106, '18,890', 0, '2014-07-07', '2046-10-01', 'pic/140619145338.jpg', 0001),
('3210500207260', 1207, 1, 'นาย', 'นายนิคม สุขประเสริฐ', '1955-04-01', 'โสด', 0116, 2, 3, 7, 0118, 0103, '34,720', 0, '1987-08-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200200162635', 1208, 1, 'นาย', 'นายนิมิตต์ ถนอมญาติ', '1958-12-10', 'โสด', 0102, 1, 2, 5, 0121, 0106, '30,310', 0, '1987-01-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3102002496122', 1209, 1, 'นาย', 'นายไพฑูรย์ มุสิกรัตน์', '1959-08-20', 'โสด', 0116, 1, 3, 8, 0125, 0106, '21,240', 0, '1995-11-27', '0000-00-00', 'pic/140619145338.jpg', 0001),
('5250200054910', 1215, 1, 'นาย', 'นายธงชัย ฟองกำแหง', '1961-03-02', 'โสด', 0116, 1, 3, 9, 0122, 0106, '13,700', 0, '2010-03-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3410100018221', 1218, 1, 'นาย', 'นายพัฒนศักดิ์ สิทธิโคตร', '1973-08-15', 'โสด', 0116, 1, 3, 8, 0115, 0106, '17,750', 0, '1997-06-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500074201', 1222, 1, 'นาย', 'นายลือชา จามลิกุล', '1963-05-29', 'โสด', 0116, 2, 3, 8, 0134, 0106, '22,220', 0, '1995-11-27', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1100200349951', 1223, 1, 'นาย', 'นายศราวุธ โพธิกุล', '1987-11-07', 'โสด', 0110, 1, 2, 6, 0111, 0106, '13,200', 0, '2010-07-01', '0000-00-00', 'pic/141016164357.jpg', 0001),
('3200900385823', 1224, 2, 'น.ส', 'นางสาวชันษา เจริญศรี', '1970-08-03', 'โสด', 0112, 1, 3, 8, 0121, 0106, '24,710', 0, '1992-07-16', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3219900025086', 1225, 1, 'นาย', 'นายจิรศักดิ์ ดิเรกฤทธิกุลชัย', '1957-03-02', 'โสด', 0102, 1, 2, 5, 0121, 0106, '39,610', 0, '1981-12-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3140800057078', 1226, 1, 'นาย', 'นายแสวง ทองสีจัด', '1959-12-01', 'โสด', 0102, 1, 2, 5, 0122, 0106, '33,620', 0, '1987-01-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3229900066726', 1229, 2, 'นาง', 'นางบังอร ขรรค์ศร', '1956-11-12', 'สมรส', 0116, 1, 3, 8, 0125, 0106, '31,190', 0, '1987-08-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3260200009870', 1235, 2, 'นาง', 'นางอุทัยวรรญ จีนสง่า', '1954-02-06', 'สมรส', 0116, 2, 3, 8, 0118, 0103, '31,970', 0, '1987-08-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3251100404794', 1239, 1, 'นาย', 'นายอดุลย์ เจือจันทร์', '1967-11-08', 'โสด', 0116, 1, 3, 8, 0122, 0106, '23,850', 0, '1995-11-27', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200100622324', 1240, 2, 'น.ส', 'นางสาวบุญยืน คุ้มทรัพย์', '1963-02-08', 'โสด', 0115, 1, 3, 8, 0122, 0106, '26,480', 0, '1992-05-06', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3240400138282', 1241, 2, 'นาง', 'นางโสภิดา ยอดแสง', '1965-07-31', 'สมรส', 0112, 1, 3, 8, 0122, 0106, '26,040', 0, '1991-02-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220300520631', 1243, 1, 'นาย', 'นายไพบูรณ์ สมจินดา', '1957-10-21', 'โสด', 0116, 1, 3, 7, 0125, 0106, '34,510', 0, '1987-08-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3210300858674', 1244, 2, 'น.ส', 'นางสาวปราณี ถาวรศิริ', '1979-09-10', 'โสด', 0102, 1, 2, 6, 0139, 0106, '19,470', 0, '2004-05-11', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3330900703336', 1245, 2, 'นาง', 'นางวรรณา ผลอ้อ', '1968-01-09', 'สมรส', 0102, 1, 2, 5, 0123, 0106, '39,630', 0, '1990-04-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200500128581', 1248, 1, 'นาย', 'นายรุ่ง วงษ์นาค', '1967-12-20', 'โสด', 0116, 1, 3, 9, 0121, 0106, '13,370', 0, '2010-08-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250400759368', 1256, 1, 'นาย', 'นายธนากร กำเหนิด', '1969-02-16', 'โสด', 0116, 1, 3, 9, 0122, 0106, '13,950', 0, '2007-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3100500975977', 1258, 2, 'นาง', 'นางสายอมร เจริญกุล', '1959-10-25', 'สมรส', 0116, 1, 3, 8, 0123, 0106, '32,270', 0, '1980-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3160100545517', 1259, 2, 'นาง', 'นางกองเพ็ชร์ ดอกไม้เพ็ง', '1968-03-07', 'สมรส', 0116, 1, 3, 8, 0123, 0106, '26,840', 0, '1989-11-16', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500122612', 1260, 1, 'นาย', 'นายษีวะรัง สังข์ทอง', '1959-03-13', 'โสด', 0116, 1, 3, 7, 0124, 0106, '30,830', 0, '1988-01-04', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3650800702564', 1261, 2, 'นาง', 'นางนันทวัน เฮงตระกูลเวนิช', '1977-11-07', 'สมรส', 0102, 1, 2, 6, 0117, 0106, '22,360', 0, '2002-08-13', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500055966', 1262, 2, 'นาง', 'นางยุพิน วรฉัตร', '1962-11-20', 'สมรส', 0102, 1, 2, 5, 0124, 0106, '27,680', 0, '1987-01-05', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100239768', 1268, 1, 'นาย', 'นายเสมา รัชยาว', '1966-08-08', 'โสด', 0116, 1, 3, 8, 0124, 0106, '24,090', 0, '1995-11-27', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3251000090488', 1269, 1, 'นาย', 'นายชัยยงค์ กุหลาบ', '1965-04-17', 'โสด', 0116, 1, 3, 8, 0122, 0106, '15,670', 0, '2005-06-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500184162', 1270, 1, 'นาย', 'นายไตรมิตร ยิสารคุณ', '1962-07-28', 'โสด', 0116, 1, 3, 8, 0124, 0106, '29,070', 0, '1988-01-04', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230300025877', 1271, 1, 'นาย', 'นายสมศักดิ์ เสนาะสันต์', '1957-03-06', 'โสด', 0116, 1, 3, 8, 0124, 0106, '25,540', 0, '1987-08-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230400196291', 1272, 2, 'นาง', 'นางราตรี เชื้อฉลาด', '1964-04-17', 'สมรส', 0116, 1, 3, 8, 0125, 0106, '23,160', 0, '1995-11-27', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100171799', 1273, 2, 'น.ส', 'นางสาวศรีจันทร์ แก่นบุญ', '1959-02-16', 'โสด', 0116, 2, 3, 8, 0118, 0103, '33,200', 0, '1981-12-21', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1301700134979', 1274, 2, 'น.ส', 'นางสาวอรสา แดนไธสง', '1988-12-13', 'โสด', 0116, 1, 3, 9, 0124, 0106, '13,640', 0, '2010-11-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250100582411', 1275, 2, 'น.ส', 'นางสาวอุไรวรรณ ถาดทอง', '1923-03-18', 'โสด', 0102, 1, 2, 5, 0139, 0106, '43600', 0, '1979-09-22', '0000-00-00', 'pic/151204133628.png', 0001),
('3521200024346', 1276, 2, 'น.ส', 'นางสาวชบาไพร เสาร์สุวรรณ', '1976-09-10', 'โสด', 0102, 1, 2, 5, 0116, 0106, '21,990', 0, '2002-08-29', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3150600141407', 1277, 1, 'นาย', 'นายเฉลิมชัย เตชะรัตน์', '1962-12-06', 'โสด', 0102, 1, 2, 6, 0125, 0106, '24,450', 0, '1994-12-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3800600005884', 1283, 1, 'นาย', 'นายจีรพจน์ มณเทียรทอง', '1966-08-29', 'โสด', 0116, 1, 3, 9, 0122, 0106, '14,280', 0, '2007-10-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3251200269554', 1284, 1, 'นาย', 'นายสุเนตร ยะถาคาร', '1957-02-06', 'โสด', 0116, 1, 3, 8, 0131, 0106, '13,570', 0, '2011-06-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3760100742406', 1289, 1, 'นาย', 'นายประเมศฐ์ ชัยจิระคุณานนท์', '1960-12-08', 'โสด', 0116, 1, 3, 8, 0125, 0106, '28,820', 0, '1988-01-04', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220300607558', 1290, 2, 'นาง', 'นางจงดี นิยมสุข', '1959-12-09', 'สมรส', 0116, 1, 3, 8, 0125, 0106, '28,270', 0, '1988-01-04', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220200281685', 1291, 1, 'นาย', 'นายอนุกูล จรัลทรัพย์', '1967-11-16', 'โสด', 0116, 1, 3, 8, 0125, 0106, '25,030', 0, '1995-06-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220300126835', 1292, 1, 'นาย', 'นายสิรภพ อิ่มรัตน์', '1961-07-06', 'โสด', 0116, 1, 3, 8, 0119, 0106, '14,760', 0, '2007-05-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3430100797734', 1293, 1, 'นาย', 'นายทองปิว วงศ์ภูมี', '1971-10-06', 'โสด', 0116, 1, 3, 8, 0125, 0106, '21,960', 0, '1997-06-23', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3120100492677', 1295, 2, 'นาง', 'นางอุษา แย้มศรี', '1966-02-03', 'สมรส', 0112, 1, 3, 8, 0125, 0106, '24,840', 0, '1990-11-09', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220600160478', 1416, 1, 'นาย', 'นายสมยศ จันทเลิศ', '1974-04-22', 'โสด', 0116, 1, 3, 8, 0125, 0106, '25,170', 0, '1994-12-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220300606977', 1423, 1, 'นาย', 'นายธนู พรรคอนันต์', '1963-01-14', 'โสด', 0116, 1, 3, 8, 0125, 0106, '30,820', 0, '1987-01-05', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200100370864', 3730, 2, 'นาง', 'นางปิ่นกมล สมพีร์วงศ์', '1976-07-10', 'สมรส', 0104, 1, 2, 6, 0114, 0106, '23,300', 0, '2009-03-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200100809556', 3732, 2, 'นาง', 'นางลดาวัณย์ อานนท์ศิริโชติ', '1980-06-25', 'สมรส', 0116, 1, 3, 8, 0121, 0106, '18,690', 0, '2004-05-11', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3210300330271', 3733, 2, 'น.ส', 'นางสาวฉวีวรรณ ตรึกหากิจ', '1979-07-18', 'โสด', 0116, 1, 3, 8, 0123, 0106, '19,030', 0, '2004-05-11', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1200600108976', 3731, 2, 'น.ส', 'นางสาวมะลิวัลย์ สุรินทร์', '1987-08-10', 'โสด', 0102, 1, 2, 6, 0139, 0106, '18,110', 0, '2014-09-01', '2047-10-01', '', 0001),
('3200900335451', 0166, 1, 'นาย', 'นายวชิระ มากเจริญ', '1960-06-11', 'โสด', 0129, 3, 3, 9, 0113, 0106, '16,030', 0, '1984-11-05', '0000-00-00', 'pic/141016164414.jpg', 0001),
('3200101213355', 0167, 1, 'นาย', 'นายสมชาย เกิดปราง', '1967-07-26', 'โสด', 0132, 3, 3, 9, 0113, 0106, '16,030', 0, '1990-06-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200101043077', 0566, 1, 'นาย', 'นายวิชาญ วงษ์สุนทร', '1972-12-08', 'โสด', 0127, 3, 3, 9, 0111, 0106, '17,270', 0, '1999-09-14', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200101206685', 0568, 1, 'นาย', 'นายวิรัตน์ จุลนพ', '1963-12-24', 'โสด', 0127, 3, 3, 9, 0111, 0106, '19,660', 0, '1995-04-10', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200100375513', 0569, 1, 'นาย', 'นายพิเชษ ภูกาบพลอย', '1963-06-07', 'โสด', 0127, 3, 3, 9, 0111, 0106, '16,030', 0, '1999-07-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3209900411491', 0570, 1, 'นาย', 'นายภิญโญ กาญจนสิงห์', '1965-04-13', 'โสด', 0127, 3, 3, 9, 0111, 0106, '21,140', 0, '1990-07-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3209600034322', 0571, 2, 'นาง', 'นางลออ ทวีรัตน์', '1957-09-11', 'สมรส', 0128, 3, 3, 9, 0111, 0106, '16,030', 0, '1996-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200100100867', 0574, 1, 'นาย', 'นายวัฒนา ยูถะสุนทร', '1961-04-01', 'โสด', 0127, 3, 3, 9, 0111, 0106, '21,140', 0, '1993-08-04', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3659900370111', 1097, 2, 'น.ส', 'น.ส.หรรษา รักษาคม', '1975-05-01', 'โสด', 0101, 1, 1, 1, 0109, 0106, '40270', 0, '1999-04-01', '0000-00-00', 'pic/151130113113.png', 0001),
('3200500284019', 0580, 2, 'นาง', 'นางสุพิน กุณฑลบุตร', '1963-05-31', 'สมรส', 0134, 3, 3, 9, 0111, 0106, '17,880', 0, '1983-04-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3209900290545', 0581, 2, 'นาง', 'นางสุวรรณา กนะกาศัย', '1954-07-15', 'สมรส', 0116, 2, 3, 9, 0111, 0103, '18,190', 0, '1977-10-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3209900033071', 0582, 2, 'น.ส', 'นางสาวธนพร พิกุลทอง', '1955-03-07', 'โสด', 0116, 2, 3, 9, 0111, 0103, '18,790', 0, '1979-12-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200100169689', 0584, 2, 'นาง', 'นางเสาวลักษณ์ พรงาม', '1964-06-10', 'สมรส', 0133, 3, 3, 9, 0118, 0106, '16,030', 0, '1989-05-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3240500329438', 0585, 2, 'นาง', 'นางสุธามาศ เที่ยงตรง', '1968-11-01', 'สมรส', 0133, 3, 3, 9, 0113, 0106, '16,030', 0, '1991-06-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200101180945', 0586, 2, 'นาง', 'นางวันเพ็ญ เกิดปราง', '1955-11-30', 'สมรส', 0131, 3, 3, 9, 0113, 0106, '20,400', 0, '1988-07-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200701032033', 0589, 2, 'น.ส', 'นางสาวอัญชลี นาคแท้', '1966-07-12', 'โสด', 0126, 3, 3, 9, 0111, 0106, '18,480', 0, '1996-06-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220200053283', 0590, 1, 'นาย', 'นายศักดิ์ชัย วงษ์สุวรรณ', '1959-01-25', 'โสด', 0135, 3, 3, 9, 0111, 0106, '16,030', 0, '1992-12-16', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3100600924576', 0593, 2, 'นาง', 'นางอัญชนา นัดพบสุข', '1967-09-30', 'สมรส', 0126, 3, 3, 9, 0119, 0106, '20,770', 0, '1990-02-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220100424557', 0594, 2, 'นาง', 'นางกนกวรรณ สุวรรณา', '1957-07-21', 'สมรส', 0131, 3, 3, 9, 0119, 0106, '20,770', 0, '1977-08-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200100365984', 0595, 1, 'นาย', 'นายอรรณพ สารพัฒน์', '1965-11-10', 'โสด', 0127, 3, 3, 9, 0111, 0106, '21,140', 0, '1993-07-16', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3451100518950', 0597, 1, 'นาย', 'นายไพฑูรย์ มิรัตนไพร', '1963-01-26', 'โสด', 0132, 3, 3, 9, 0111, 0106, '16,030', 0, '1988-12-12', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250100582403', 0600, 2, 'น.ส', 'นางสาวอรวรรณ ถาดทอง', '1954-02-03', 'โสด', 0116, 2, 3, 9, 0111, 0103, '30,790', 0, '1975-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250700107820', 0609, 1, 'นาย', 'นายทองทิพย์ ทุมมี', '1954-05-31', 'โสด', 0116, 2, 3, 9, 0111, 0103, '20,770', 0, '1989-08-10', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3100202757939', 0610, 1, 'นาย', 'นายสมพงษ์ ศรีสก', '1956-10-07', 'โสด', 0124, 3, 3, 9, 0123, 0106, '20,770', 0, '1979-06-08', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100435630', 0611, 1, 'นาย', 'นายบุญลือ เพ็ชรมาก', '1961-11-29', 'โสด', 0124, 3, 3, 9, 0124, 0106, '20,770', 0, '1985-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3360100772597', 0613, 1, 'นาย', 'นายชนะ แม้นชัยภูมิ', '1959-11-17', 'โสด', 0124, 3, 3, 9, 0125, 0106, '20,770', 0, '1987-08-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220100356446', 0614, 1, 'นาย', 'นายคำนวณ เฉียบแหลม', '1957-11-06', 'โสด', 0125, 3, 3, 9, 0123, 0106, '20,770', 0, '1983-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3809900603947', 0616, 1, 'นาย', 'นายสุนันท์ วุฒิศักดิ์', '1962-12-25', 'โสด', 0124, 3, 3, 9, 0123, 0106, '18,790', 0, '1991-04-15', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200900485259', 0619, 1, 'นาย', 'นายสุทธิ งามเสงี่ยม', '1961-04-02', 'โสด', 0124, 3, 3, 9, 0123, 0106, '20,400', 0, '1987-02-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500147275', 0627, 1, 'นาย', 'นายมนตรี พยาเวช', '1959-04-08', 'โสด', 0124, 3, 3, 9, 0124, 0106, '20,770', 0, '1980-06-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100127315', 0628, 1, 'นาย', 'นายธัญญา ถนอมชาติ', '1954-07-04', 'โสด', 0116, 2, 3, 9, 0111, 0103, '21,140', 0, '1983-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230300278791', 0629, 1, 'นาย', 'นายเฉลิม ใจเที่ยง', '1961-09-18', 'โสด', 0124, 3, 3, 9, 0123, 0106, '20,770', 0, '1983-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3251000096737', 0630, 1, 'นาย', 'นายสมยงค์ กันหา', '1957-05-08', 'โสด', 0125, 3, 3, 9, 0122, 0106, '20,770', 0, '1981-06-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230400201367', 0633, 1, 'นาย', 'นายเรวัฒ เขมะชัยเวช', '1960-07-23', 'โสด', 0124, 3, 3, 9, 0124, 0106, '20,400', 0, '1980-08-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3710600096643', 0635, 1, 'นาย', 'นายบุญรัตน์ บุญประเสริฐ', '1966-08-12', 'โสด', 0124, 3, 3, 9, 0121, 0106, '20,770', 0, '1988-08-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220300607540', 0638, 1, 'นาย', 'นายแฉล้ม นิยมสุข', '1960-02-28', 'โสด', 0124, 3, 3, 9, 0125, 0106, '21,500', 0, '1979-10-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220200346329', 0642, 1, 'นาย', 'นายณรงค์ ศิลาปาน', '1961-10-09', 'โสด', 0124, 3, 3, 9, 0125, 0106, '20,770', 0, '1980-08-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3140100337370', 0648, 1, 'นาย', 'นายประวัติ ชูชีพ', '1955-11-27', 'โสด', 0124, 3, 3, 9, 0123, 0106, '21,140', 0, '1978-11-06', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200700054530', 0650, 1, 'นาย', 'นายวิริยะ สุทธศิริ', '1955-10-10', 'โสด', 0124, 3, 3, 9, 0121, 0106, '20,770', 0, '1980-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('5230590003070', 0651, 1, 'นาย', 'นายจรัญ เหมินทสูตร', '1960-12-18', 'โสด', 0116, 2, 3, 9, 0111, 0103, '20,770', 0, '1981-02-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220100191218', 0653, 2, 'นาง', 'นางรุ่งทิวา จงประเสริฐกิจ', '1963-11-23', 'สมรส', 0126, 3, 3, 9, 0125, 0106, '18,480', 0, '1984-06-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3100502303003', 0654, 2, 'นาง', 'นางประนอม แสนรักษ์', '1960-09-26', 'สมรส', 0126, 3, 3, 9, 0122, 0106, '21,140', 0, '1984-04-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100298853', 0655, 2, 'นาง', 'นางสุทธิลักษณ์ รัตนเพียร', '1961-06-26', 'สมรส', 0126, 3, 3, 9, 0124, 0106, '21,500', 0, '1985-03-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220100351932', 0656, 2, 'นาง', 'นางศิวิไล สีหมอก', '1966-11-02', 'สมรส', 0126, 3, 3, 9, 0125, 0106, '21,500', 0, '1989-04-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3219900313138', 0660, 2, 'นาง', 'นางพรทิพย์ คล้ายสุด', '1959-01-26', 'สมรส', 0125, 3, 3, 9, 0123, 0106, '20,770', 0, '1977-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100458052', 0663, 2, 'นาง', 'นางวิภา ดุงแผ้ว', '1960-12-25', 'สมรส', 0125, 3, 3, 9, 0124, 0106, '20,770', 0, '1979-07-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3210300394660', 0668, 2, 'นาง', 'นางวรรณวิภา มะลิวัลย์', '1958-05-12', 'สมรส', 0125, 3, 3, 9, 0123, 0106, '20,770', 0, '1985-06-05', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3209800051204', 0671, 1, 'นาย', 'นายประวิทย์ สีวัน', '1957-06-15', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1977-08-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500047963', 0675, 1, 'นาย', 'นายสมภพ พิมพา', '1955-07-01', 'โสด', 0116, 2, 3, 9, 0111, 0103, '20,770', 0, '1981-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100452682', 0676, 1, 'นาย', 'นายอนนท์ นพเก้า', '1965-03-09', 'โสด', 0125, 3, 3, 9, 0124, 0106, '20,770', 0, '1987-08-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3210500724710', 0678, 2, 'นาง', 'นางวิมล สุขวารี', '1957-10-14', 'สมรส', 0125, 3, 3, 9, 0123, 0106, '20,770', 0, '1978-06-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200700143541', 0679, 2, 'นาง', 'นางพวงแข เสรีปิยะกุล', '1957-11-19', 'สมรส', 0125, 3, 3, 9, 0121, 0106, '21,140', 0, '1976-01-02', '0000-00-00', 'pic/141016165213.jpg', 0001),
('3209700088025', 0680, 2, 'น.ส', 'นางสาวเยาวภา แสงล้ำเลิศ', '1959-11-13', 'โสด', 0125, 3, 3, 9, 0121, 0106, '20,770', 0, '1980-03-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220300240816', 0681, 1, 'นาย', 'นายแย้ม ดีสิงห์บุญ', '1955-09-06', 'โสด', 0116, 2, 3, 9, 0111, 0103, '20,770', 0, '1976-12-06', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3210500027784', 0683, 2, 'นาง', 'นางรัตนา สีดา', '1958-02-17', 'สมรส', 0125, 3, 3, 9, 0123, 0106, '20,770', 0, '1978-06-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100493478', 0684, 2, 'นาง', 'นางพิณทอง สุกสด', '1955-06-13', 'สมรส', 0116, 2, 3, 9, 0111, 0103, '20,770', 0, '1977-08-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250401098896', 0686, 1, 'นาย', 'นายทองพูน ด่านประชุม', '1961-09-29', 'โสด', 0124, 3, 3, 9, 0122, 0106, '20,770', 0, '1986-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('5220100002578', 0688, 1, 'นาย', 'นายจีระศักดิ์ ปิ่นแก้ว', '1964-10-06', 'โสด', 0124, 3, 3, 9, 0125, 0106, '20,770', 0, '1986-06-19', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220600080822', 0689, 1, 'นาย', 'นายสุขุม ศรีสังข์', '1958-12-20', 'โสด', 0125, 3, 3, 9, 0125, 0106, '21,140', 0, '1983-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3440100068562', 0690, 1, 'นาย', 'นายวรศักดิ์ ลาจ้อย', '1964-08-05', 'โสด', 0124, 3, 3, 9, 0125, 0106, '19,660', 0, '1987-08-05', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3229800001878', 0700, 1, 'นาย', 'นายร่มโพธิ์ มงคลสุข', '1956-02-15', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1984-06-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3150400232549', 0703, 1, 'นาย', 'นายมานะ กุสลา', '1959-02-15', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1977-11-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3251000031848', 0704, 1, 'นาย', 'นายกล้าณรงค์ แก้วประสิทธิ์', '1959-04-07', 'โสด', 0125, 3, 3, 9, 0122, 0106, '20,400', 0, '1977-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3210300822301', 0710, 1, 'นาย', 'นายสมชาย คงคางาม', '1956-06-18', 'โสด', 0136, 3, 3, 9, 0123, 0106, '21,880', 0, '1978-04-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3361200214040', 0716, 1, 'นาย', 'นายนิยม มั่นคง', '1961-08-31', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1983-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3141500075802', 0722, 1, 'นาย', 'นายประจวบ จำนงธรรม', '1955-05-19', 'โสด', 0116, 2, 3, 9, 0111, 0103, '21,140', 0, '1974-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3251200293072', 0724, 1, 'นาย', 'นายแดง โตเจริญ', '1957-04-21', 'โสด', 0125, 3, 3, 9, 0122, 0106, '20,770', 0, '1983-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250400447447', 0726, 1, 'นาย', 'นายนิพจน์ ขวัญพงษ์', '1954-05-01', 'โสด', 0116, 2, 3, 9, 0111, 0103, '20,770', 0, '1977-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3210600098993', 0729, 1, 'นาย', 'นายศรีศักดิ์ เส็งเจริญ', '1954-08-15', 'โสด', 0116, 2, 3, 9, 0111, 0103, '21,880', 0, '1981-06-08', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3440100065679', 0732, 1, 'นาย', 'นายโชคชัย เทียมมาลา', '1964-03-15', 'โสด', 0125, 3, 3, 9, 0125, 0106, '19,100', 0, '1987-08-05', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220400444332', 0734, 1, 'นาย', 'นายสุรพล สิทธิเวช', '1957-08-10', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1982-08-17', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3229900031230', 0735, 1, 'นาย', 'นายจำลอง เพียรชอบ', '1958-02-19', 'โสด', 0124, 3, 3, 9, 0125, 0106, '20,770', 0, '1984-06-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3640300009754', 0736, 1, 'นาย', 'นายชาญ ถึงทุ่ง', '1961-09-29', 'โสด', 0124, 3, 3, 9, 0125, 0106, '20,040', 0, '1986-06-19', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200300130590', 0740, 1, 'นาย', 'นายสมหมาย คำสมาน', '1958-04-11', 'โสด', 0125, 3, 3, 9, 0121, 0106, '20,770', 0, '1977-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3210100604563', 0741, 1, 'นาย', 'นายธราธร ซื่อประเสริฐ', '1957-01-08', 'โสด', 0116, 2, 3, 9, 0111, 0103, '21,140', 0, '1977-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3239900073561', 0743, 1, 'นาย', 'นายสมนึก ภู่มณี', '1962-03-25', 'โสด', 0125, 3, 3, 9, 0124, 0106, '20,400', 0, '1983-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500048145', 0744, 1, 'นาย', 'นายชัยรัตน์ พุฒดี', '1958-12-20', 'โสด', 0136, 3, 3, 9, 0124, 0106, '21,880', 0, '1983-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220500028896', 0745, 2, 'นาง', 'นางดวงพร พัฒนพานิช', '1961-10-23', 'สมรส', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1982-04-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3240200242418', 0746, 2, 'นาง', 'นางจำนงค์ เวชสถล', '1954-12-01', 'สมรส', 0116, 2, 3, 9, 0111, 0103, '20,040', 0, '1980-03-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('5102400023514', 0753, 1, 'นาย', 'นายอังกูร ชาวิลัย', '1961-04-09', 'โสด', 0124, 3, 3, 9, 0124, 0106, '17,880', 0, '1991-11-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250200187841', 0754, 1, 'นาย', 'นายพิเภก แก้ววงษ์ศา', '1954-09-21', 'โสด', 0116, 2, 3, 9, 0111, 0103, '16,030', 0, '1998-09-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3160400486109', 0755, 2, 'นาง', 'นางณกัญญา เนียมโสต', '1967-09-17', 'สมรส', 0126, 3, 3, 9, 0121, 0106, '19,100', 0, '1989-07-12', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3240800364832', 0757, 1, 'นาย', 'นายอนุ เข็มจรุญ', '1955-10-22', 'โสด', 0124, 3, 3, 9, 0121, 0106, '20,770', 0, '1980-03-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3259700054953', 0758, 1, 'นาย', 'นายบุญรวม สนศิริ', '1964-04-18', 'โสด', 0124, 3, 3, 9, 0125, 0106, '18,480', 0, '1993-08-04', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500184171', 0759, 1, 'นาย', 'นายสมัคร ยิสารคุณ', '1965-01-10', 'โสด', 0124, 3, 3, 9, 0124, 0106, '18,480', 0, '1990-05-10', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220200007257', 0766, 1, 'นาย', 'นายนพดล ผลาหารกิจ', '1962-03-03', 'โสด', 0124, 3, 3, 9, 0125, 0106, '20,400', 0, '1983-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3640300009746', 0767, 1, 'นาย', 'นายวันชัย ถึงทุ่ง', '1959-04-21', 'โสด', 0124, 3, 3, 9, 0125, 0106, '20,040', 0, '1989-04-07', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500144624', 0768, 1, 'นาย', 'นายเกษตร สินทราลักษณ์', '1959-08-19', 'โสด', 0124, 3, 3, 9, 0124, 0106, '18,480', 0, '1989-05-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3100503400550', 0770, 1, 'นาย', 'นายณรงค์ศักดิ์ ฤทธิ์เรืองเดช', '1972-08-07', 'โสด', 0125, 3, 3, 9, 0124, 0106, '17,570', 0, '1996-09-11', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220400556726', 0771, 1, 'นาย', 'นายประพิศ คนสอาด', '1965-11-10', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1987-08-05', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100477847', 0772, 1, 'นาย', 'นายไพโรจน์ ตะติชรา', '1968-11-03', 'โสด', 0124, 3, 3, 9, 0124, 0106, '18,480', 0, '1992-01-14', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220300019613', 0773, 1, 'นาย', 'นายสมชาย ภิรมย์เปรม', '1960-08-11', 'โสด', 0125, 3, 3, 9, 0125, 0106, '21,140', 0, '1983-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3251000289403', 0774, 1, 'นาย', 'นายสุวรรณ บานเย็น', '1963-02-13', 'โสด', 0124, 3, 3, 9, 0122, 0106, '20,400', 0, '1986-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500095194', 0775, 1, 'นาย', 'นายสมศักดิ์ กัตตะเวที', '1964-10-27', 'โสด', 0125, 3, 3, 9, 0124, 0106, '20,400', 0, '1990-05-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3239900073552', 0777, 1, 'นาย', 'นายสุนิต ภู่มณี', '1960-08-06', 'โสด', 0124, 3, 3, 9, 0124, 0106, '20,400', 0, '1985-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500160069', 0780, 1, 'นาย', 'นายพงศธร วรรณคุณ', '1967-09-19', 'โสด', 0125, 3, 3, 9, 0124, 0106, '18,790', 0, '1993-08-04', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100247728', 0783, 1, 'นาย', 'นายธานี วาสุกรี', '1968-05-09', 'โสด', 0125, 3, 3, 9, 0124, 0106, '18,480', 0, '1992-05-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3709900065300', 0784, 1, 'นาย', 'นายธีระวุฒิ ปิ่นแก้ว', '1967-04-23', 'โสด', 0124, 3, 3, 9, 0125, 0106, '16,960', 0, '1995-03-20', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230400010651', 0785, 1, 'นาย', 'นายสมยศ ต่างหู', '1973-11-29', 'โสด', 0125, 3, 3, 9, 0124, 0106, '16,960', 0, '1998-03-16', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100537408', 0786, 1, 'นาย', 'นายประดิษฐ์ นองเนือง', '1966-02-19', 'โสด', 0124, 3, 3, 9, 0124, 0106, '20,040', 0, '1988-02-04', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220200038721', 0790, 1, 'นาย', 'นายสวัสดิ์ชัย ปุระณะ', '1964-06-10', 'โสด', 0124, 3, 3, 9, 0125, 0106, '20,040', 0, '1989-04-07', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500047696', 0791, 1, 'นาย', 'นายชาญชัย มหาโสม', '1960-06-11', 'โสด', 0124, 3, 3, 9, 0124, 0106, '20,770', 0, '1982-11-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220300467179', 0792, 1, 'นาย', 'นายมนตรี คณะรมย์', '1968-01-20', 'โสด', 0125, 3, 3, 9, 0125, 0106, '18,480', 0, '1994-05-16', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3360300210657', 0793, 1, 'นาย', 'นายปราโมทย์ เมตตา', '1967-12-06', 'โสด', 0124, 3, 3, 9, 0125, 0106, '20,770', 0, '1988-07-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3350400294291', 0795, 1, 'นาย', 'นายสมศักดิ์ สังข์ศรี', '1964-05-07', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1987-08-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220400135291', 0796, 1, 'นาย', 'นายเดช ดวงตา', '1961-04-29', 'โสด', 0124, 3, 3, 9, 0133, 0106, '21,140', 0, '1986-01-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220300520681', 0800, 1, 'นาย', 'นายสนทยา สมจินดา', '1967-03-25', 'โสด', 0124, 3, 3, 9, 0125, 0106, '18,480', 0, '1995-12-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3320200199201', 0801, 1, 'นาย', 'นายเลิศฤทธิ์ เกียรติกันยา', '1972-01-27', 'โสด', 0124, 3, 3, 9, 0122, 0106, '16,960', 0, '1997-05-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500038263', 0802, 1, 'นาย', 'นายภูสิทธิ์ จินดาสมบัติ', '1968-02-02', 'โสด', 0124, 3, 3, 9, 0124, 0106, '18,480', 0, '1991-03-18', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220200286881', 0803, 1, 'นาย', 'นายบดี กงไกรลาศ', '1957-07-17', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1982-04-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500061575', 0804, 1, 'นาย', 'นายสุกรี พูลธนพันธ์', '1960-04-13', 'โสด', 0124, 3, 3, 9, 0124, 0106, '20,400', 0, '1988-06-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200500172202', 0806, 2, 'นาง', 'นางอรุณรัตน์ ตุลาพันธ์', '1958-01-15', 'สมรส', 0125, 3, 3, 9, 0121, 0106, '20,770', 0, '1979-08-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220100491327', 0809, 1, 'นาย', 'นายสมศักดิ์ แสงผ่อง', '1962-06-18', 'โสด', 0125, 3, 3, 9, 0125, 0106, '21,500', 0, '1986-01-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3101900380068', 0812, 1, 'นาย', 'นายบำรุง ปิตยานนท์', '1967-05-11', 'โสด', 0125, 3, 3, 9, 0125, 0106, '18,480', 0, '1992-03-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220500028373', 0813, 1, 'นาย', 'นายภิรมย์ ทองเจียน', '1963-09-21', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1987-08-05', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3239900090503', 0814, 1, 'นาย', 'นายวรสิทธิ์ หอมวิลัย', '1965-07-31', 'โสด', 0124, 3, 3, 9, 0125, 0106, '18,190', 0, '1991-08-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230300222214', 0816, 2, 'น.ส', 'นางสาวจันทร์จิรา มวญนรา', '1971-04-24', 'โสด', 0124, 3, 3, 9, 0124, 0106, '16,030', 0, '1999-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3341400232831', 0817, 1, 'นาย', 'นายมนตรี บุปผาหอม', '1961-06-21', 'โสด', 0124, 3, 3, 9, 0125, 0106, '18,190', 0, '1992-03-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220400018724', 0818, 1, 'นาย', 'นายยุทธนา ปั้นชู', '1972-05-03', 'โสด', 0124, 3, 3, 9, 0125, 0106, '15,720', 0, '2000-08-21', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100198433', 0820, 1, 'นาย', 'นายอนุศาสตร์ ใจเที่ยง', '1969-03-01', 'โสด', 0124, 3, 3, 9, 0124, 0106, '19,660', 0, '1991-12-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250700288417', 0821, 1, 'นาย', 'นายนิกร ถนอมมิตร', '1963-07-21', 'โสด', 0125, 3, 3, 9, 0122, 0106, '20,770', 0, '1987-08-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220500028608', 0823, 1, 'นาย', 'นายสุทิน ทองเจียน', '1965-04-08', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1986-01-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3251100022051', 0827, 1, 'นาย', 'นายพีระพันธ์ พุฒภูงา', '1972-01-11', 'โสด', 0124, 3, 3, 9, 0122, 0106, '15,440', 0, '2001-05-14', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3471200577362', 0829, 1, 'นาย', 'นายชุมชน ทองโคตร', '1967-10-08', 'โสด', 0125, 3, 3, 9, 0125, 0106, '18,480', 0, '1989-04-07', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3260200021047', 0830, 1, 'นาย', 'นายอนันต์ เมธานิธิภักดี', '1964-05-18', 'โสด', 0124, 3, 3, 9, 0122, 0106, '18,480', 0, '1992-05-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500143971', 0833, 1, 'นาย', 'นายอวยพร ทิณวรรณ', '1958-05-14', 'โสด', 0124, 3, 3, 9, 0124, 0106, '20,400', 0, '1986-07-18', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230400194115', 0836, 1, 'นาย', 'นายเชาว์ คางงูเหลือม', '1964-12-17', 'โสด', 0125, 3, 3, 9, 0124, 0106, '18,790', 0, '1992-11-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220300766184', 0837, 1, 'นาย', 'นายนพดล ประสมสุข', '1960-03-14', 'โสด', 0124, 3, 3, 9, 0125, 0106, '18,480', 0, '1985-03-20', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220500069410', 0838, 1, 'นาย', 'นายวินัย จันท์แดง', '1958-09-02', 'โสด', 0125, 3, 3, 9, 0125, 0106, '21,140', 0, '1982-07-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220300065356', 0840, 1, 'นาย', 'นายปริญญา บรรพต', '1961-03-04', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1983-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3210500567223', 0844, 1, 'นาย', 'นายสมโภชน์ เกิดศิริ', '1959-03-27', 'โสด', 0125, 3, 3, 9, 0123, 0106, '20,770', 0, '1988-06-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3470400261619', 0846, 1, 'นาย', 'นายประยุทธ ปัญญาประชุม', '1965-05-21', 'โสด', 0125, 3, 3, 9, 0124, 0106, '20,040', 0, '1989-11-13', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200900202621', 0850, 1, 'นาย', 'นายมานัส มีทรัพย์ปรุง', '1961-01-08', 'โสด', 0125, 3, 3, 9, 0121, 0106, '21,140', 0, '1981-06-15', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3120101198390', 0851, 1, 'นาย', 'นายขจรศักดิ์ พรหมมานะ', '1958-03-14', 'โสด', 0125, 3, 3, 9, 0121, 0106, '20,770', 0, '1979-08-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3259900063263', 0853, 2, 'นาง', 'นางพรศรี บุญยืน', '1955-04-16', 'สมรส', 0116, 2, 3, 9, 0111, 0103, '21,140', 0, '1976-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250700138636', 0854, 1, 'นาย', 'นายสุทิน เทียบเศียร', '1959-05-13', 'โสด', 0124, 3, 3, 9, 0122, 0106, '20,400', 0, '1984-12-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230300256593', 0855, 1, 'นาย', 'นายอภิสิทธิ์ แสงอรุณ', '1968-09-24', 'โสด', 0124, 3, 3, 9, 0124, 0106, '18,190', 0, '1991-06-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230400241962', 0857, 1, 'นาย', 'นายบัญชา ละลิ่ว', '1958-08-30', 'โสด', 0125, 3, 3, 9, 0124, 0106, '17,270', 0, '1996-09-11', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220100206240', 0858, 1, 'นาย', 'นายกำธร ศรีสาคร', '1963-07-27', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1989-04-07', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220400448095', 0859, 1, 'นาย', 'นายสมบัติ แสงม่วงยาง', '1967-12-17', 'โสด', 0125, 3, 3, 9, 0119, 0106, '20,040', 0, '1988-07-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220200288493', 0860, 1, 'นาย', 'นายสุทธิพงษ์ ศรีวรรณ', '1968-08-21', 'โสด', 0125, 3, 3, 9, 0125, 0106, '18,480', 0, '1990-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250400437867', 0861, 1, 'นาย', 'นายสมาน เทียมครู', '1964-02-09', 'โสด', 0125, 3, 3, 9, 0122, 0106, '20,400', 0, '1988-05-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250700303505', 0863, 1, 'นาย', 'นายกิตติคุณ ไพรบึง', '1965-07-02', 'โสด', 0124, 3, 3, 9, 0124, 0106, '19,660', 0, '1991-03-18', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220300854709', 0864, 1, 'นาย', 'นายประมวญ ประจงจัด', '1963-06-07', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1986-04-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200200664746', 0867, 1, 'นาย', 'นายสมชาย ขุนสกล', '1961-02-04', 'โสด', 0126, 3, 3, 9, 0123, 0106, '18,190', 0, '1996-03-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220400408069', 0868, 1, 'นาย', 'นายสมหวัง โสรัมภา', '1967-06-20', 'โสด', 0124, 3, 3, 9, 0125, 0106, '18,190', 0, '1993-10-18', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100534140', 0871, 1, 'นาย', 'นายธงชัย หงษ์ตะนุ', '1963-01-23', 'โสด', 0125, 3, 3, 9, 0124, 0106, '20,770', 0, '1988-01-13', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220200119101', 0872, 1, 'นาย', 'นายมงคล เขมะบาล', '1965-01-21', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1988-07-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3239900087308', 0873, 2, 'นาง', 'นางยุพาภรณ์ สิทธิโสภณ', '1955-12-26', 'สมรส', 0116, 2, 3, 9, 0111, 0103, '20,400', 0, '1978-08-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220200346337', 0876, 1, 'นาย', 'นายสมพงษ์ รัตนแสง', '1963-01-19', 'โสด', 0116, 2, 3, 9, 0111, 0103, '18,480', 0, '1982-04-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230400156311', 0877, 1, 'นาย', 'นายภานุวัฒน์ สาระทะนงค์', '1962-02-13', 'โสด', 0124, 3, 3, 9, 0124, 0106, '17,880', 0, '1992-10-15', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3210500430091', 0878, 1, 'นาย', 'นายสายชล ม่วงสุขศรี', '1955-04-09', 'โสด', 0116, 2, 3, 9, 0111, 0103, '20,400', 0, '1977-08-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230300282951', 0879, 1, 'นาย', 'นายเสน่ห์ ทานะสิงห์', '1961-10-05', 'โสด', 0124, 3, 3, 9, 0124, 0106, '20,400', 0, '1982-04-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3251100211937', 0881, 1, 'นาย', 'นายเกียว พรหมอังกูร', '1969-11-04', 'โสด', 0124, 3, 3, 9, 0125, 0106, '17,270', 0, '1998-09-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('5220400018933', 0883, 2, 'นาง', 'นางสุภลักษณ์ มิสานุช', '1962-07-29', 'สมรส', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1982-04-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220100250095', 0884, 1, 'นาย', 'นายประจักษ์ ตังแก', '1961-06-15', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,400', 0, '1982-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3920100332826', 0886, 1, 'นาย', 'นายวิชัย ยินห้อง', '1963-06-01', 'โสด', 0124, 3, 3, 9, 0124, 0106, '17,570', 0, '1996-09-11', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230200091487', 0887, 2, 'นาง', 'นางมุกดา ท่าพริก', '1963-12-22', 'สมรส', 0125, 3, 3, 9, 0124, 0106, '20,770', 0, '1987-05-04', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220500174230', 0889, 1, 'นาย', 'นายสิทธิชัย รักษา', '1973-08-11', 'โสด', 0124, 3, 3, 9, 0125, 0106, '16,960', 0, '1998-09-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3209900347075', 0890, 1, 'นาย', 'นายสมเกียรติ สาระพากร', '1960-07-06', 'โสด', 0125, 3, 3, 9, 0121, 0106, '21,140', 0, '1979-08-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200200637447', 0891, 1, 'นาย', 'นายเชื้อ มินา', '1954-01-01', 'โสด', 0116, 2, 3, 9, 0111, 0103, '20,770', 0, '1979-08-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3219900332027', 0892, 1, 'นาย', 'นายชัยนันท์ อินทรปาน', '1973-10-22', 'โสด', 0116, 2, 3, 9, 0111, 0103, '18,480', 0, '1995-04-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3210100224311', 0894, 1, 'นาย', 'นายบรรทม ประสิทธิแพทย์', '1955-01-10', 'โสด', 0116, 2, 3, 9, 0111, 0103, '21,140', 0, '1977-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3210100485572', 0896, 1, 'นาย', 'นายมงคล กิจพิทักษ์', '1966-04-12', 'โสด', 0124, 3, 3, 9, 0123, 0106, '20,400', 0, '1988-06-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3219800052103', 0897, 1, 'นาย', 'นายบัวพา เหมนาค', '1955-10-09', 'โสด', 0124, 3, 3, 9, 0123, 0106, '20,770', 0, '1977-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500184197', 0904, 1, 'นาย', 'นายวัชระ ยิสารคุณ', '1968-05-04', 'โสด', 0124, 3, 3, 9, 0124, 0106, '18,480', 0, '1994-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3239900083426', 0905, 2, 'นาง', 'นางพรวนา นพวรรณ', '1967-03-25', 'สมรส', 0125, 3, 3, 9, 0124, 0106, '20,770', 0, '1987-05-04', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250500087221', 0907, 1, 'นาย', 'นายไกรทอง กองเงิน', '1958-07-18', 'โสด', 0125, 3, 3, 9, 0122, 0106, '16,650', 0, '1998-08-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3319900247231', 0908, 2, 'น.ส', 'นางสาวสุชีลา ภุมรา', '1976-01-20', 'โสด', 0126, 3, 3, 9, 0124, 0106, '15,440', 0, '1999-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100475917', 0909, 1, 'นาย', 'นายรักชาติ รอดพิเศษ', '1968-04-03', 'โสด', 0124, 3, 3, 9, 0124, 0106, '17,570', 0, '1997-09-15', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250700214952', 0913, 1, 'นาย', 'นายพิเชษฐ สู่สุข', '1963-07-01', 'โสด', 0124, 3, 3, 9, 0122, 0106, '19,660', 0, '1990-07-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220400170313', 0914, 1, 'นาย', 'นายบุญจันทร์ บัวใหญ่', '1970-01-19', 'โสด', 0124, 3, 3, 9, 0125, 0106, '17,270', 0, '1995-10-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('5220400013281', 0915, 1, 'นาย', 'นายเอกชัย หารกลับ', '1961-07-28', 'โสด', 0125, 3, 3, 9, 0119, 0106, '21,140', 0, '1986-01-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250400713163', 0917, 1, 'นาย', 'นายสมบัติ จองจับ', '1968-09-24', 'โสด', 0124, 3, 3, 9, 0122, 0106, '18,190', 0, '1994-11-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3239900080290', 0919, 1, 'นาย', 'นายสิทธิพงษ์ หงษ์ร่อน', '1963-12-22', 'โสด', 0124, 3, 3, 9, 0124, 0106, '18,480', 0, '1992-05-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250700213689', 0920, 1, 'นาย', 'นายวิชัย กำเนิดบุญ', '1960-01-30', 'โสด', 0124, 3, 3, 9, 0122, 0106, '18,790', 0, '1991-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220200198974', 0921, 1, 'นาย', 'นายทวีป บรรจง', '1963-04-21', 'โสด', 0124, 3, 3, 9, 0125, 0106, '20,400', 0, '1982-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3730100633275', 0922, 1, 'นาย', 'นายฉัชชัย ทองคง', '1963-01-29', 'โสด', 0126, 3, 3, 9, 0124, 0106, '18,480', 0, '1987-05-04', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250400713147', 0923, 1, 'นาย', 'นายนิธินันท์ จองจับ', '1974-11-17', 'โสด', 0124, 3, 3, 9, 0122, 0106, '18,790', 0, '1992-01-15', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100242696', 0924, 1, 'นาย', 'นายชูศักดิ์ หนองแพ', '1973-11-25', 'โสด', 0125, 3, 3, 9, 0124, 0106, '16,030', 0, '1999-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500048137', 0925, 1, 'นาย', 'นายบุญธรรม อยู่บุญ', '1962-03-27', 'โสด', 0124, 3, 3, 9, 0124, 0106, '20,770', 0, '1983-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220400334081', 0926, 1, 'นาย', 'นายจรูญ ปิ่นแก้ว', '1961-09-03', 'โสด', 0125, 3, 3, 9, 0125, 0106, '20,770', 0, '1980-02-04', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220500028527', 0927, 1, 'นาย', 'นายราเชนทร์ บัวผลิ', '1968-12-11', 'โสด', 0124, 3, 3, 9, 0125, 0106, '15,140', 0, '2001-11-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220200302160', 0928, 1, 'นาย', 'นายสมชาย ทรงธรรม', '1964-03-17', 'โสด', 0124, 3, 3, 9, 0125, 0106, '20,040', 0, '1989-04-07', '0000-00-00', 'pic/140619145338.jpg', 0001),
('5230490004805', 0930, 1, 'นาย', 'นายวัฒนา บัวคำ', '1964-06-02', 'โสด', 0125, 3, 3, 9, 0124, 0106, '21,140', 0, '1985-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230400201359', 0931, 1, 'นาย', 'นายสมบูรณ์ ศรีดารากุล', '1958-06-23', 'โสด', 0125, 3, 3, 9, 0124, 0106, '21,140', 0, '1981-07-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100001770', 0932, 2, 'นาง', 'นางอำพร ทานะสิงห์', '1963-10-27', 'สมรส', 0125, 3, 3, 9, 0124, 0106, '19,660', 0, '1988-06-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220100424531', 0934, 1, 'นาย', 'นายอัศวิน เสมี', '1976-01-24', 'โสด', 0137, 3, 3, 9, 0125, 0106, '15,140', 0, '2001-11-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3471201049246', 0935, 1, 'นาย', 'นายบุญพึ่ง จิตรราช', '1969-05-12', 'โสด', 0124, 3, 3, 9, 0125, 0106, '18,480', 0, '1994-05-26', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230400156248', 0936, 1, 'นาย', 'นายรุ่งศักดิ์ ชูกำแพง', '1963-05-17', 'โสด', 0125, 3, 3, 9, 0124, 0106, '20,770', 0, '1990-02-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230500201261', 0937, 1, 'นาย', 'นายสุทธิชัย สรรพนุเคราะห์', '1965-07-20', 'โสด', 0124, 3, 3, 9, 0119, 0106, '18,480', 0, '1991-03-18', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3209900050684', 0940, 1, 'นาย', 'นายพยนต์ แสงสว่าง', '1965-09-13', 'โสด', 0125, 3, 3, 9, 0125, 0106, '17,270', 0, '1998-09-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3269900017512', 0942, 1, 'นาย', 'นายสุรเดช ยอดแสง', '1960-07-16', 'โสด', 0124, 3, 3, 9, 0122, 0106, '21,140', 0, '1991-05-15', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220100431707', 0943, 1, 'นาย', 'นายสิทธิเดช มณีเหล่างาม', '1973-05-16', 'โสด', 0127, 3, 3, 9, 0125, 0106, '16,340', 0, '2001-04-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3120101926140', 0944, 1, 'นาย', 'นายสมชาย แสนรักษ์', '1955-09-12', 'โสด', 0116, 2, 3, 9, 0111, 0103, '21,140', 0, '1974-12-30', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3220100416325', 0945, 1, 'นาย', 'นายอทิติ นิลน้อย', '1966-11-20', 'โสด', 0137, 3, 3, 9, 0125, 0106, '20,770', 0, '1989-04-21', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3260100154886', 0948, 1, 'นาย', 'นายประเสริฐ เจริญนิตย์', '1955-09-19', 'โสด', 0116, 2, 3, 9, 0111, 0103, '21,140', 0, '1976-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3250100122364', 0949, 1, 'นาย', 'นายลำยอง มีอนันต์', '1957-08-19', 'โสด', 0127, 3, 3, 9, 0122, 0106, '20,770', 0, '1984-12-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3210100649389', 0952, 1, 'นาย', 'นายวิชัย ตระกูลหิรัญ', '1956-07-04', 'โสด', 0127, 3, 3, 9, 0123, 0106, '20,040', 0, '1980-11-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3219800033478', 0953, 1, 'นาย', 'นายเพชร์ พงศ์แพทย์', '1963-08-07', 'โสด', 0124, 3, 3, 9, 0123, 0106, '21,140', 0, '1989-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3170500028650', 0958, 1, 'นาย', 'นายวิชาญ ตุ้มชี', '1966-02-22', 'โสด', 0124, 3, 3, 9, 0123, 0106, '18,790', 0, '1994-05-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('5100200069101', 0960, 1, 'นาย', 'นายวีระศักดิ์ วรรณไสย', '1964-07-28', 'โสด', 0124, 3, 3, 9, 0122, 0106, '18,190', 0, '1991-05-20', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3209700039148', 0961, 1, 'นาย', 'นายโด่ง สุวรรณมงคล', '1953-12-03', 'โสด', 0116, 2, 3, 9, 0111, 0103, '20,770', 0, '1976-10-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200900773149', 0966, 1, 'นาย', 'นายณรงค์ แดงสุก', '1961-03-28', 'โสด', 0128, 3, 3, 9, 0111, 0106, '16,030', 0, '1993-05-28', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230400079537', 1147, 1, 'นาย', 'นายชาญเดช ฤทธิ์เรืองเดช', '1977-09-25', 'โสด', 0124, 3, 3, 9, 0124, 0106, '15,440', 0, '2000-01-04', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3321000592636', 1842, 1, 'นาย', 'นายรัตน์ มะวัน', '1966-08-30', 'โสด', 0125, 3, 3, 9, 0124, 0106, '18,790', 0, '1990-02-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3920100821754', 1844, 1, 'นาย', 'นายวิชาญ ทองพิทักษ์', '1962-12-29', 'โสด', 0124, 3, 3, 9, 0125, 0106, '19,660', 0, '1990-02-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1420200008930', 0014, 2, 'น.ส', 'นางสาววิมลรัตน์ ปัสสาวัฒนะ', '1985-02-15', 'โสด', 0106, 2, 3, 9, 0116, 0106, '18,920', 0, '2010-04-19', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200101166357', 0036, 2, 'น.ส', 'นางสาวนพรินทร์ ปู่ชูประเสริฐ', '1963-12-02', 'โสด', 0116, 2, 3, 9, 0117, 0106, '12,620', 0, '2005-11-10', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3560300135122', 0037, 2, 'น.ส', 'นางสาวสุพิชญา บัวผัด', '1973-02-01', 'โสด', 0116, 2, 3, 9, 0111, 0106, '12,630', 0, '2005-11-10', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3251100540230', 0042, 2, 'น.ส', 'นางสาวอนัญญา ม่วงพรหม', '1969-12-04', 'โสด', 0116, 2, 3, 9, 0122, 0106, '12,670', 0, '2005-11-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200101172985', 0043, 2, 'น.ส', 'นางสาวปรานอม สุขีฐาน', '1962-02-01', 'โสด', 0116, 2, 3, 9, 0118, 0106, '12,620', 0, '2005-11-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3470100228373', 0105, 2, 'นาง', 'นางอัจฉรา ปัญญาประชุม', '1966-03-15', 'สมรส', 0116, 2, 3, 9, 0124, 0106, '12,550', 0, '2006-04-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3510300041098', 0218, 1, 'นาย', 'นายอาทิตย์ บุญสุทธิ์', '1982-08-22', 'โสด', 0122, 2, 3, 9, 0116, 0106, '20,720', 0, '2008-01-18', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1310400087338', 0219, 1, 'นาย', 'นายบุญล้อม พูนสวัสดิ์', '1986-06-19', 'โสด', 0123, 2, 3, 9, 0116, 0106, '14,100', 0, '2013-01-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1679900236699', 0220, 2, 'น.ส', 'นางสาวอนัญญา หาบุญมี', '1991-12-22', 'โสด', 0102, 2, 3, 9, 0115, 0106, '18,000', 0, '2014-07-15', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1430800006121', 0221, 2, 'นาง', 'นางสุภาพร ศรพรหม', '1985-06-22', 'สมรส', 0102, 2, 3, 9, 0112, 0106, '18,920', 0, '2010-04-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('2849900020994', 0222, 2, 'น.ส', 'นางสาวปรียาพร เทือกสุบรรณ', '1983-11-24', 'โสด', 0138, 2, 3, 9, 0121, 0106, '19,590', 0, '2006-08-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1341100152119', 0223, 2, 'น.ส', 'นางสาวศศิธร แพนสมบัติ', '1990-01-06', 'โสด', 0116, 2, 3, 9, 0111, 0103, '18,390', 0, '2012-12-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3110200516276', 0224, 1, 'นาย', 'นายธีรยุทธ ก่ำสีดา', '1983-04-10', 'โสด', 0138, 2, 3, 9, 0123, 0106, '19,760', 0, '2006-08-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1330300120309', 0225, 2, 'น.ส', 'นางสาวมณีรัตน์ โนนสังข์', '1989-01-24', 'โสด', 0116, 2, 3, 9, 0111, 0103, '18,000', 0, '2014-02-04', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1509900475511', 0226, 2, 'น.ส', 'นางสาวสุธาสินี มาแดง', '1987-03-28', 'โสด', 0116, 2, 3, 9, 0111, 0103, '18,640', 0, '2011-11-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1460900055973', 0393, 2, 'น.ส', 'นางสาวเพ็ญศิริ นาถวิล', '1989-11-02', 'โสด', 0102, 2, 3, 9, 0113, 0106, '18,000', 0, '2014-07-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('2419900006235', 0403, 1, 'นาย', 'นายสุทธิพร บู่ทอง', '1985-01-30', 'โสด', 0121, 2, 3, 9, 0112, 0106, '19,180', 0, '2009-08-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3300900070830', 0404, 2, 'น.ส', 'นางสาววรางคณา ยาแก้ว', '1983-04-27', 'โสด', 0118, 2, 3, 9, 0111, 0106, '18,500', 0, '2012-07-16', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3609900394568', 0454, 2, 'น.ส', 'นางสาวศิวัช ฐิตมงคล', '1977-06-25', 'โสด', 0102, 2, 3, 9, 0112, 0106, '19,370', 0, '2007-09-26', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1459900082901', 0455, 2, 'น.ส', 'นางสาวกรกมล ดวงใส', '1987-02-04', 'โสด', 0102, 2, 3, 9, 0113, 0106, '18,800', 0, '2012-01-16', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3200700326777', 0579, 2, 'น.ส', 'นางสาวนิอร แสงเนตร์', '1977-08-30', 'โสด', 0118, 2, 3, 9, 0117, 0106, '18,500', 0, '2013-01-02', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1190500031913', 0580, 2, 'น.ส', 'นางสาวกวินนาฏ งามสมชน', '1986-10-01', 'โสด', 0119, 2, 3, 9, 0114, 0106, '18,640', 0, '2011-06-30', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1129900054064', 0581, 1, 'นาย', 'นายปิยภัทร มาลาอี', '1989-05-22', 'โสด', 0120, 2, 3, 9, 0114, 0106, '18,500', 0, '2012-09-13', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1409900511675', 0585, 2, 'น.ส', 'นางสาวพวงพยอม มูลวงศ์', '1989-01-11', 'โสด', 0138, 2, 2, 6, 0122, 0106, '18,390', 0, '2012-12-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1300600016132', 0586, 2, 'น.ส', 'นางสาววรัญญา สบาย', '1985-04-11', 'โสด', 0138, 2, 3, 9, 0123, 0106, '18,640', 0, '2011-07-04', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3230100464371', 0587, 1, 'นาย', 'นายนันทภพ เกณิกานนท์', '1976-08-01', 'โสด', 0138, 2, 3, 9, 0124, 0106, '18,780', 0, '2011-03-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1361000107782', 0588, 2, 'น.ส', 'นางสาวปาริฉัตร บุรัมย์สูงเนิน', '1987-11-08', 'โสด', 0116, 2, 3, 9, 0118, 0103, '18,750', 0, '2011-07-04', '0000-00-00', 'pic/140619145338.jpg', 0001);
INSERT INTO `tb_profile` (`card_id`, `pro_idpos`, `pro_sex`, `pro_first`, `pro_name`, `pro_birthday`, `pro_status`, `pro_position`, `pro_type`, `pro_linework`, `pro_level`, `code_class`, `dep_code`, `pro_salary`, `status_boss`, `pro_datefromservice`, `pro_datetoservice`, `pro_filepic`, `id_profile`) VALUES
('5729999002964', 0724, 1, 'นาย', 'นายสุพัฒน์ เล็กพันธ์', '1981-10-31', 'โสด', 0139, 2, 3, 9, 0118, 0106, '18,500', 0, '2012-09-03', '0000-00-00', 'pic/140619145338.jpg', 0001),
('5551200006727', 0725, 2, 'น.ส', 'นางสาวดวงจันทร์ อุดเต็น', '1983-02-28', 'โสด', 0106, 2, 3, 6, 0118, 0106, '18,390', 0, '2012-09-13', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1530700081643', 0785, 1, 'นาย', 'นายชิงชัย โคกสว่าง', '1991-01-16', 'โสด', 0102, 2, 3, 9, 0116, 0106, '18,000', 0, '2014-07-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1549900231507', 0786, 1, 'นาย', 'นายอภิลักษณ์ สลักหล่าย', '1990-09-27', 'โสด', 0102, 2, 3, 9, 0118, 0106, '18,000', 0, '2014-07-07', '0000-00-00', 'pic/140619145338.jpg', 0001),
('1219900228967', 0844, 2, 'น.ส', 'นางสาวทิฏฐิตา พูลสุทธิ์', '1989-10-29', 'โสด', 0107, 2, 3, 9, 0137, 0106, '18,000', 0, '2014-09-01', '0000-00-00', 'pic/140619145338.jpg', 0001),
('3809800164640', 1114, 2, 'นาง', 'นางสุภาพร พุทธรัตน์', '1963-12-17', 'สมรส', 0102, 1, 2, 4, 0138, 0106, '57,290', 0, '1986-04-01', '2024-10-01', 'pic/151201141022.png', 0001),
('3240400341622', 1129, 2, 'นาง', 'นางรวิสรา จิรโรตน์วัฒน', '1960-07-06', 'สมรส', 0102, 1, 2, 4, 0138, 0106, '56,020', 0, '1982-04-01', '2020-10-01', '', 0001),
('3100902326167', 1175, 1, 'นาย', 'จ่าสิบเอกพูนศักดิ์ ศรีประพัฒน์', '1960-09-23', '', 0102, 1, 2, 4, 0140, 0106, '50,340', 0, '1977-05-13', '2020-10-01', '', 0001),
('3200100374797', 3607, 1, 'นาย', 'นายณรงค์ศักดิ์ ทองธรรมชาติ', '1969-12-24', 'สมรส', 0102, 1, 2, 5, 0113, 0106, '35,530', 0, '1991-06-03', '2030-10-01', '', 0001),
('3100203271185', 1187, 2, 'นาง', 'นางนิดาพร สมศักดิ์', '1981-12-25', 'สมรส', 0102, 1, 2, 6, 0113, 0106, '22,750', 0, '2001-04-02', '1942-10-01', '', 0001),
('3100503700341', 1127, 2, 'นาง', 'นางลานทิพย์ เหราบัตย์', '1969-04-23', 'สมรส', 0141, 1, 2, 4, 0114, 0106, '33,830', 0, '2008-01-06', '2029-10-01', 'pic/151201140205.png', 0001),
('3200400056502', 1118, 2, 'น.ส', 'นางสาวอภิญญา เปี่ยมวัฒนาทรัพย์', '1969-12-21', 'โสด', 0102, 1, 2, 4, 0114, 0106, '39,550', 0, '1990-04-02', '2030-10-01', '', 0001),
('3739900349707', 1166, 2, 'นาง', 'นางศุภญดา แสงสมเรือง', '1960-03-15', 'สมรส', 0105, 1, 2, 4, 0114, 0106, '50,240', 0, '1982-06-07', '2020-10-01', '', 0001),
('3800200083489', 1164, 2, 'นาง', 'นางสาวณัฐธิสา บุญเจริญ', '1982-11-12', 'สมรส', 0102, 1, 2, 5, 0114, 0106, '21,520', 0, '2008-10-13', '2043-10-01', '', 0001),
('5200100040674', 1140, 2, 'น.ส', 'นางสาวบุญรักษา วิทยาคม', '1965-03-09', 'โสด', 0103, 1, 2, 5, 0114, 0106, '42,440', 0, '1984-04-02', '2025-10-01', '', 0001),
('3220300744881', 1151, 2, 'นาง', 'นางจันทร์เกษร นนกันทา', '1959-09-14', 'สมรส', 0103, 1, 2, 5, 0114, 0106, '36,870', 0, '1977-10-03', '2019-10-01', '', 0001),
('3330101175088', 1145, 2, 'น.ส', 'นางสาวฐพัชร์ คันศร', '1971-08-30', 'โสด', 0103, 1, 2, 5, 0114, 0106, '29,840', 0, '1991-12-02', '2031-10-01', '', 0001),
('3240700035314', 1136, 2, 'นาง', 'นางสาวอารีย์ พรหมปัญญา', '1983-04-03', 'โสด', 0103, 1, 2, 6, 0114, 0106, '18,370', 0, '2005-12-01', '2043-10-01', '', 0001),
('3199900161509', 1176, 0, '', 'นางจันทร์เพ็ญ เรือนคง', '1962-02-19', 'สมรส', 0102, 1, 2, 4, 0115, 0106, '56,020', 0, '1984-04-02', '1963-10-01', '', 0001),
('3269900005051', 1138, 2, 'นาง', 'นางกิรณา เอี่ยมสำอางค์', '1956-10-11', 'สมรส', 0103, 1, 2, 5, 0115, 0106, '41,150', 0, '1977-10-03', '2017-10-01', '', 0001),
('3100800449693', 1199, 1, 'นาย', 'นายชะฎายุทธ์ ปัทเมฆ', '1968-05-28', 'โสด', 0102, 1, 2, 5, 0115, 0106, '40,310', 0, '1991-06-03', '2028-10-01', '', 0001),
('3440700163981', 1121, 2, 'นาง', 'นางมนตริยา อุ่นเทียมโสม', '1977-04-18', 'สมรส', 0102, 1, 2, 5, 0115, 0106, '27,100', 0, '2005-01-17', '2037-10-01', '', 0001),
('3140100040962', 1130, 1, 'นาย', 'นายผาสุข ญาณสมบัติ', '1957-03-07', 'สมรส', 0102, 1, 2, 5, 0115, 0106, '42,060', 0, '1981-11-02', '2017-10-01', '', 0001),
('1102000676631', 1200, 2, 'น.ส', 'นางสาวรัตนา สันติอาภรณ์', '1986-09-29', 'โสด', 0102, 1, 2, 6, 0115, 0106, '18,740', 0, '2012-02-10', '2046-10-01', '', 0001),
('3341100511638', 1194, 1, 'นาย', 'นายเทพฤทธิ์ ทองเกลี้ยง', '1979-01-04', 'โสด', 0102, 1, 2, 5, 0115, 0106, '24,000', 0, '2004-05-11', '2039-10-01', '', 0001),
('3119800099968', 1113, 2, 'นาง', 'นางสุจิตรา เทพมงคล', '1966-06-10', 'สมรส', 0102, 1, 2, 5, 0117, 0106, '43,440', 0, '1989-04-03', '2026-10-01', '', 0001),
('3709900105158', 1132, 2, 'นาง', 'นางนุชนาฏ รองศรีแย้ม', '1963-03-10', 'โสด', 0102, 1, 2, 5, 0116, 0106, '43,330', 0, '1984-04-02', '2023-10-01', '', 0001),
('3240500018866', 1201, 2, 'นาง', 'นางดารณี จุนเจริญวงศา', '1974-12-23', 'สมรส', 0102, 1, 2, 4, 0116, 0106, '34,890', 0, '1996-04-01', '2035-10-01', '', 0001),
('5440490007403', 1188, 2, 'น.ส', 'นางสาวเกศริน ขอหน่วงกลาง', '1980-07-08', 'โสด', 0102, 1, 2, 5, 0116, 0106, '24,470', 0, '2004-05-11', '2040-10-01', '', 0001),
('3549900170105', 1115, 2, 'นาง', 'นางชนันภรณ์ เทียนแก้ว', '1975-10-20', 'สมรส', 0102, 1, 2, 5, 0117, 0106, '31,140', 0, '1998-09-28', '2036-10-01', '', 0001),
('3730300159712', 1182, 2, 'น.ส', 'นางสาวเบ็ญจมาศ พฤฒารา', '1980-01-07', 'โสด', 0106, 1, 2, 6, 0117, 0106, '23,760', 0, '2002-01-21', '2040-10-01', '', 0001),
('5710390032918', 1116, 2, 'นาง', 'นางจิรากัญ ปักเคเต', '1981-04-11', 'สมรส', 0116, 1, 2, 6, 0117, 0106, '13,940', 0, '2012-07-02', '2041-10-01', '', 0001),
('3140900219177', 1105, 2, 'นาง', 'นางจงจิตต์ สุขปราโมทย์', '1958-02-14', 'สมรส', 0110, 1, 2, 5, 0111, 0000, '43,300', 0, '0000-00-00', '2018-10-01', '', 0001),
('3200101297591', 1109, 2, 'นาง', 'นางดวงใจ โชตินันทน์', '1958-12-17', 'สมรส', 0111, 1, 2, 5, 0111, 0106, '40,870', 0, '1979-11-01', '2019-10-01', '', 0001),
('3251200580900', 1106, 2, 'นาง', 'นางนิศารัตน์ จารุจินดา', '1965-05-18', 'สมรส', 0110, 1, 2, 5, 0111, 0106, '30,630', 0, '1986-09-01', '2025-10-01', '', 0001),
('4101700003579', 1111, 2, 'นาง', 'นางยุวัฒนางค์ ทีสกุล', '1962-05-08', 'สมรส', 0113, 1, 2, 5, 0111, 0106, '41,480', 0, '1984-02-27', '2022-10-01', '', 0001),
('3200100949358', 1102, 2, 'นาง', 'นางจามรี สกุลทรงเดช', '1966-04-06', 'หย่า', 0115, 1, 2, 5, 0111, 0106, '31,420', 0, '1991-03-18', '2026-10-01', '', 0001),
('3209900155630', 1108, 2, 'นาง', 'นางสาววิมล พันธุมะโอภาส', '1965-05-08', 'สมรส', 0112, 1, 0, 8, 0000, 0106, '36,550', 0, '1989-04-04', '2025-10-01', '', 0001),
('3251000174088', 1109, 2, 'น.ส', 'นางสาวสุวิมล จันทร์สมร', '1973-01-07', 'โสด', 0112, 1, 2, 8, 0111, 0106, '21,200', 0, '2002-11-11', '2033-10-01', '', 0001),
('1660100084217', 1107, 0, 'น.ส', 'นางสาวอนงค์ ฉ่ำชื่น', '1986-08-24', 'โสด', 0112, 1, 2, 6, 0111, 0106, '11,850', 0, '2015-09-14', '2046-10-01', '', 0001),
('3200100473167', 1112, 2, 'นาง', 'นางวณิชชา ศรีประพัฒน์', '1969-05-04', 'สมรส', 0114, 1, 2, 8, 0111, 0106, '33,210', 0, '1990-07-25', '2029-10-01', '', 0001),
('3200500367551', 1101, 2, 'น.ส', 'นางสาวรุ่งทิพย์ แจ่มจำรัส', '1970-12-08', 'โสด', 0115, 1, 2, 8, 0111, 0106, '24,520', 0, '1998-04-01', '2031-10-01', '', 0001),
('3200100767489', 1103, 2, 'นาง', 'นางกชพร หน่ายคอน', '1958-04-24', 'สมรส', 0115, 1, 2, 8, 0111, 0106, '28,080', 0, '2005-02-07', '2018-10-01', '', 0001),
('3301100086015', 1100, 2, 'น.ส', 'นางสาวอุ่นเรือน เครื่องกลาง', '1977-03-06', 'โสด', 0111, 1, 2, 6, 0111, 0106, '16,470', 0, '2008-09-15', '2037-10-01', '', 0001),
('3200600875248', 1197, 2, 'น.ส', 'นางสาวสมปอง โรจน์รุ่งศศิธร', '1966-07-25', 'โสด', 0102, 1, 2, 4, 0112, 0106, '44,720', 0, '1989-04-03', '2026-10-01', '', 0001),
('3110100805888', 1143, 2, 'น.ส', 'นางสาวจรรยา ภู่กลั่น', '1968-04-20', 'โสด', 0103, 1, 2, 5, 0112, 0106, '30,000', 0, '1994-03-16', '2028-10-01', '', 0001),
('5200199010446', 1142, 2, 'นาง', 'นางอรนิภา เอี่ยมสำอางค์', '1965-05-16', 'โสด', 0103, 1, 2, 5, 0112, 0106, '41,970', 0, '1985-10-01', '2025-10-01', '', 0001),
('3650800719025', 1144, 2, 'นาง', 'นางวารุณี เอ็บมูล', '1966-07-26', 'สมรส', 0103, 1, 2, 5, 0112, 0106, '39,380', 0, '1989-04-03', '2026-10-01', '', 0001),
('1149900136907', 1141, 2, 'น.ส', 'นางสาวกมลวรรณ คุ้มวงษ์', '1988-07-21', 'โสด', 0103, 1, 2, 6, 0112, 0106, '18,500', 0, '2012-07-02', '2048-10-01', '', 0001),
('3570400352681', 1199, 2, 'น.ส', 'นางสาวนิตยา ปัญญากัณฑ์', '1979-12-15', 'โสด', 0102, 1, 2, 6, 0112, 0106, '22,340', 0, '2011-12-01', '2040-10-01', '', 0001),
('3321000695842', 1154, 2, 'น.ส', 'นางสาวนงเยาว์ มีสิทธิ์', '1973-08-04', 'โสด', 0107, 1, 2, 5, 0137, 0106, '29,460', 0, '1999-01-29', '2033-10-01', '', 0001),
('1840100066047', 1153, 2, 'น.ส', 'นางสาวจันทร์พร ผลาสิงห์', '1985-10-21', 'โสด', 0107, 1, 2, 6, 0137, 0106, '20,250', 0, '2011-07-01', '2046-10-01', '', 0001),
('1720600017712', 1156, 1, 'นาย', 'นายตะวัน หนองเพียร', '1986-01-22', 'โสด', 0107, 1, 2, 6, 0137, 0106, '19,610', 0, '2012-04-02', '2046-10-01', '', 0001),
('3101501193663', 1192, 2, 'นาง', 'นางประทีป ปั้นทอง', '1960-02-13', 'สมรส', 0102, 1, 2, 5, 0135, 0106, '43,600', 0, '1978-12-01', '2020-10-01', '', 0001),
('3209900231107', 1126, 1, 'นาย', 'ร้อยเอกชูเกียรติ ขวัญขจรเกียรติ', '1958-10-26', 'โสด', 0141, 1, 2, 4, 0135, 0106, '50,550', 0, '1985-04-01', '2019-10-01', '', 0001),
('3300700185757', 1147, 2, 'น.ส', 'นางสาววราพร คร่ำกระโทก', '1979-12-06', 'โสด', 0103, 1, 2, 5, 0135, 0106, '25,200', 0, '2002-04-01', '2040-10-01', '', 0001),
('3470600301657', 1137, 2, 'นาง', 'นางคันธมาศ สุพัฒนกุล', '1983-05-20', 'สมรส', 0103, 1, 2, 5, 0135, 0106, '19,390', 0, '2008-07-28', '2043-10-01', '', 0001),
('3509900003756', 1135, 1, 'นาย', 'นายสุรชาติ สุวิปาลวัฒน์', '1964-06-02', 'โสด', 0116, 1, 3, 8, 0135, 0106, '28,900', 0, '2011-03-14', '2024-10-01', '', 0001),
('3200400056464', 1162, 2, 'น.ส', 'นางสาวธีรดา เปี่ยมวัฒนาทรัพย์', '1963-12-07', '', 0109, 1, 3, 8, 0135, 0106, '33,130', 0, '1987-06-01', '2024-10-01', '', 0001),
('3120100417608', 1197, 2, 'นาง', 'นางภัทรภร อิทธิวรกุล', '1960-12-01', 'สมรส', 0116, 1, 3, 8, 0135, 0106, '36,930', 0, '1980-08-01', '2021-10-01', '', 0001),
('3760100553255', 1155, 1, 'นาย', 'นายปภังกร สละรักษ์', '1977-01-26', 'โสด', 0107, 1, 3, 6, 0135, 0106, '21,420', 0, '2006-03-31', '2037-10-01', '', 0001),
('3302100854463', 1177, 2, 'น.ส', 'นางสาววรรณภา ฤทธิสนธิ์', '1976-05-15', 'โสด', 0102, 1, 2, 6, 0139, 0106, '22,770', 0, '2005-11-30', '2036-10-01', '', 0001),
('3200101391997', 1119, 2, 'นาง', 'นางวัลภา ศรีสุภาพ', '1969-05-28', 'สมรส', 0102, 1, 2, 4, 0139, 0106, '36,930', 0, '1990-04-02', '2029-10-01', '', 0001),
('1339900030023', 3734, 1, 'นาย', 'นายภัทร คันศร', '1985-10-02', 'โสด', 0102, 1, 2, 6, 0139, 0106, '19,180', 0, '2011-05-18', '2046-10-01', '', 0001),
('1709900091363', 1159, 1, 'นาย', 'นายธนกฤต กลมเกลียว', '1985-01-21', 'โสด', 0104, 1, 2, 6, 0139, 0106, '20,080', 0, '2014-11-03', '2045-10-01', '', 0001),
('3800101291130', 1160, 2, 'น.ส', 'นางสาวกรรณิตา การชะนะไชย', '1983-08-23', 'โสด', 0109, 1, 3, 6, 0139, 0106, '12,080', 0, '2015-08-03', '2043-10-01', '', 0001),
('3101501168464', 1182, 0, '', 'นายแสงสูรย์ ภู่มา', '1957-08-10', 'สมรส', 0116, 1, 3, 8, 0128, 0106, '38,410', 0, '1979-11-01', '2017-10-01', '', 0001),
('3102400693751', 1189, 1, 'นาย', 'นายอดิศักดิ์ เทียนฤทธิเดช', '1957-08-10', 'สมรส', 0102, 1, 2, 5, 0128, 0106, '43,600', 0, '1979-11-01', '2017-10-01', '', 0001),
('3101403047522', 1191, 1, 'นาย', 'นายลองเดช รายณะสุข', '1961-05-27', 'สมรส', 0102, 1, 2, 5, 0126, 0106, '43,120', 0, '1986-05-01', '2021-10-01', '', 0001),
('3200100188705', 1186, 1, 'นาย', 'นายวิทยา ยินดีสุข', '1958-11-17', 'สมรส', 0102, 1, 2, 5, 0127, 0106, '43,440', 0, '1980-05-01', '2019-10-01', '', 0001),
('3229700073125', 1134, 1, 'นาย', 'นายอรุณ เที่ยงอาชา', '1975-11-23', 'โสด', 0102, 1, 2, 5, 0127, 0106, '27,290', 0, '2006-01-23', '2036-10-01', '', 0001),
('1410600041217', 3606, 2, 'น.ส', 'นางสาวนิติพร รัตนปกรณ์', '1985-08-10', 'โสด', 0102, 1, 2, 6, 0130, 0106, '18,830', 0, '2012-05-08', '2045-10-01', '', 0001),
('3120101827249', 1195, 2, 'น.ส', 'นางสาวจินดารัตน์ โรมา', '1973-10-27', 'โสด', 0102, 1, 2, 5, 0129, 0106, '33,020', 0, '1995-04-30', '2034-10-01', '', 0001),
('3251000277197', 1190, 1, 'นาย', 'นายธนกฤต สายสิญจน์', '1962-05-01', 'โสด', 0102, 1, 2, 6, 0131, 0106, '26,900', 0, '1988-01-04', '2022-10-01', '', 0001),
('3220300941270', 1172, 1, 'นาย', 'นายสิทธิ์ เชื้อฉลาด', '1959-09-20', 'สมรส', 0116, 1, 3, 7, 0132, 0106, '44,170', 0, '1981-10-01', '2019-10-01', '', 0001);
...
--
-- Indexes for table `ps_amphur`
--
ALTER TABLE `ps_amphur`
  ADD PRIMARY KEY (`AMPHUR_ID`);

--
-- Indexes for table `ps_bank`
--
ALTER TABLE `ps_bank`
  ADD PRIMARY KEY (`bank_id`);

--
-- Indexes for table `ps_blame`
--
ALTER TABLE `ps_blame`
  ADD PRIMARY KEY (`blame_id`);

--
-- Indexes for table `ps_changname`
--
ALTER TABLE `ps_changname`
  ADD PRIMARY KEY (`chang_id`),
  ADD KEY `chang_id` (`chang_id`),
  ADD KEY `card_id` (`pro_id`);

--
-- Indexes for table `ps_class`
--
ALTER TABLE `ps_class`
  ADD PRIMARY KEY (`class_id`),
  ADD KEY `id_class` (`class_id`),
  ADD KEY `code_class` (`class_code`);
...
--
-- Indexes for table `ps_district`
--
ALTER TABLE `ps_district`
...
--
-- Indexes for table `ps_geography`
--
ALTER TABLE `ps_geography`
  ADD PRIMARY KEY (`GEO_ID`);

--
-- Indexes for table `ps_heir`
--
ALTER TABLE `ps_heir`
  ADD PRIMARY KEY (`id_heir`),
  ADD KEY `card_id` (`pro_id`),
...
--
-- Indexes for table `ps_officeout`
--
ALTER TABLE `ps_officeout`
  ADD PRIMARY KEY (`id_off`);

--
-- Indexes for table `ps_personnal`
--
...
--
-- Indexes for table `ps_province`
--
ALTER TABLE `ps_province`
  ADD PRIMARY KEY (`PROVINCE_ID`);

--
-- Indexes for table `ps_receiveservice`
--
ALTER TABLE `ps_receiveservice`
  ADD PRIMARY KEY (`service_id`);

--
-- Indexes for table `ps_religion`
--
ALTER TABLE `ps_religion`
...
ALTER TABLE `tb_profile`
  ADD PRIMARY KEY (`card_id`,`id_profile`);
...
--
-- AUTO_INCREMENT for table `ps_bank`
--
ALTER TABLE `ps_bank`
  MODIFY `bank_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `ps_department`
  MODIFY `dep_id` int(4) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `ps_district`
--
ALTER TABLE `ps_district`
...
--
ALTER TABLE `ps_officeout`
  MODIFY `id_off` int(4) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `ps_prefix`
  MODIFY `pf_id` int(2) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=16;
...
--
-- AUTO_INCREMENT for table `ps_receiveservice`
--
ALTER TABLE `ps_receiveservice`
  MODIFY `service_id` int(4) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `ps_religion`
--
ALTER TABLE `ps_religion`
