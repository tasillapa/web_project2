    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <?php 
                    ...
                    ?>
     			<div class="card" style="width:100%; width:100% height:100%;">           
    					<div  style="width:100%; width:100% height:100%;" id="chart_div"></div>
	...
	function drawChart() {
		...
		<?php 
			...
			while ($rs = mysqli_fetch_array($query)) {
				...
				if( $i == 0){
					$person = 	"<img src='../../images/img-profile/$pro_picture' height='150' width='150'><br><h5>".$rs['class_id']."&nbsp;".
								$rs['pro_fname']."&nbsp;".
				...
				if( $rs['lvb_id'] > $lvb_id ){
		?>
					["<?php echo "<img src='../../images/img-profile/$pro_picture' height='100' width='100'><br><h5>".$rs['class_id']."&nbsp;".
								$rs['pro_fname']."&nbsp;".
								$rs['pro_lname']."<br>"."<div style='color:red;'>".
								$rs['lvb_name']."&nbsp;".
								$rs['type_name']."</div>".
